 ...
 *
 * @install `sh <(curl https://pkgx.sh) marionette`
 * @name `marionette`
 * @aliases `skx/marionette`
 *
 * @example
 * ```typescript
...
export const marionettePackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) marionette' as const,
  /**
  ...
  fullPath: 'github.com/skx/marionette' as const,
}
