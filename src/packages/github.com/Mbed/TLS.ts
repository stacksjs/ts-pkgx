/**
 * **github.com/Mbed-TLS** - pkgx package
 *
 * @domain `github.com/Mbed/TLS`
 *
 * @install `pkgx github.com/Mbed-TLS`
 * @name `Mbed-TLS`
 * @aliases `github.com/Mbed-TLS`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcomMbedTLS
 ...
 */
export const githubcomMbedTLSPackage = {
  /**
...
export type GithubcomMbedTLSPackage = typeof githubcomMbedTLSPackage
