/**
 * **github.com/python-lsp** - pkgx package
 *
 * @domain `github.com/python/lsp`
 *
 * @install `pkgx github.com/python-lsp`
 * @name `python-lsp`
 * @aliases `github.com/python-lsp`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcompythonlsp
 ...
 */
export const githubcompythonlspPackage = {
  /**
...
export type GithubcompythonlspPackage = typeof githubcompythonlspPackage
