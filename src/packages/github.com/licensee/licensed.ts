/**
 * **licensed** - Package from pantry: github.com/licensee/licensed
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/licensee/licensed"
 * ```
 *
...
export const githubcomlicenseelicensedPackage = {
   ...
   */
  description: 'Package from pantry: github.com/licensee/licensed' as const,
  /**
