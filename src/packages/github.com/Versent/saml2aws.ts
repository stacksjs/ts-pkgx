 ...
 *
 * @install `sh <(curl https://pkgx.sh) saml2aws`
 * @name `saml2aws`
 * @aliases `Versent/saml2aws`
 *
 * @example
 * ```typescript
...
export const saml2awsPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) saml2aws' as const,
  /**
  ...
  fullPath: 'github.com/Versent/saml2aws' as const,
}
