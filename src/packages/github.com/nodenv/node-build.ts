/**
 * **node-build** - Package from pantry: github.com/nodenv/node-build
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/nodenv/node-build"
 * ```
 *
...
export const githubcomnodenvnodebuildPackage = {
   ...
   */
  description: 'Package from pantry: github.com/nodenv/node-build' as const,
  /**
