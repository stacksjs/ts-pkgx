/**
 * **buildkit** - Package from pantry: github.com/moby/buildkit
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/moby/buildkit"
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/github-com/moby/buildkit.md
 * @see https://ts-pkgx.netlify.app/usage
 */
export const githubcommobybuildkitPackage = {
  /**
   ...
   */
  description: 'Package from pantry: github.com/moby/buildkit' as const,
  /**
...
export type GithubcommobybuildkitPackage = typeof githubcommobybuildkitPackage
