 ...
 * @programs `migrate`
 * @version `4.18.3` (7 versions available)
 * @versions From newest version to oldest.
 *
 * @install `sh <(curl https://pkgx.sh) migrate`
 * @name `migrate`
 * @aliases `golang-migrate/migrate`
 *
 * @example
 * ```typescript
 ...
 * console.log(pkg.versions[0]) // "4.18.3" (latest)
 * ```
 *
...
export const migratePackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) migrate' as const,
  /**
