/**
 * **migrate** - Package from pantry: github.com/golang-migrate/migrate
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/golang-migrate/..."
 * ```
 *
...
export const githubcomgolangmigratemigratePackage = {
   ...
   */
  description: 'Package from pantry: github.com/golang-migrate/migrate' as const,
  /**
