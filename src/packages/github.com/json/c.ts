/**
 * **github.com/json-c** - pkgx package
 *
 * @domain `github.com/json/c`
 *
 * @install `pkgx github.com/json-c`
 * @name `json-c`
 * @aliases `github.com/json-c`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcomjsonc
 ...
 */
export const githubcomjsoncPackage = {
  /**
...
export type GithubcomjsoncPackage = typeof githubcomjsoncPackage
