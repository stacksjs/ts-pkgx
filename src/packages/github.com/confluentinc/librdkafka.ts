 ...
 *
 * @install `sh <(curl https://pkgx.sh) +github.com/confluentinc/librdkafka -- $SHELL -i`
 * @aliases `confluentinc/librdkafka`
 ...
 * const pkg = pantry.confluentinclibrdkafka
 * // Or access via domain
 * const samePkg = pantry.githubcomconfluentinclibrdkafka
 ...
 */
export const confluentinclibrdkafkaPackage = {
  /**
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +github.com/confluentinc/librdkafka -- $SHELL -i' as const,
  programs: [] as const,
  companions: [] as const,
  /**
  ...
  fullPath: 'github.com/confluentinc/librdkafka' as const,
}

export type ConfluentinclibrdkafkaPackage = typeof confluentinclibrdkafkaPackage
