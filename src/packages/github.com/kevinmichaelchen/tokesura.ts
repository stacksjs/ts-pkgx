 ...
 *
 * @install `sh <(curl https://pkgx.sh) tokesura`
 * @name `tokesura`
 * @aliases `kevinmichaelchen/tokesura`
 *
 * @example
 * ```typescript
...
export const tokesuraPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) tokesura' as const,
  /**
   ...
   */
  aliases: [
    'kevinmichaelchen/tokesura',
  ] as const,
  fullPath: 'github.com/kevinmichaelchen/tokesura' as const,
}
