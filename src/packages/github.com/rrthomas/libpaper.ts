 ...
 *
 * @install `sh <(curl https://pkgx.sh) paper`
 * @name `paper`
 * @aliases `rrthomas/libpaper`
 *
 * @example
 * ```typescript
...
export const paperPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) paper' as const,
  /**
  ...
  fullPath: 'github.com/rrthomas/libpaper' as const,
}
