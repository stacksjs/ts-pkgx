 ...
 *
 * @install `sh <(curl https://pkgx.sh) horcrux`
 * @name `horcrux`
 * @aliases `jesseduffield/horcrux`
 *
 * @example
 * ```typescript
...
export const horcruxPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) horcrux' as const,
  /**
  ...
  fullPath: 'github.com/jesseduffield/horcrux' as const,
}
