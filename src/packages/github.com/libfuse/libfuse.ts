 ...
 *
 * @install `sh <(curl https://pkgx.sh) fusermount3`
 * @name `fusermount3`
 * @aliases `libfuse/libfuse`
 *
 * @example
 * ```typescript
...
export const fusermount3Package = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) fusermount3' as const,
  /**
  ...
  fullPath: 'github.com/libfuse/libfuse' as const,
}
