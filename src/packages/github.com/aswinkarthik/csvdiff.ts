 ...
 *
 * @install `sh <(curl https://pkgx.sh) csvdiff`
 * @name `csvdiff`
 * @aliases `aswinkarthik/csvdiff`
 *
 * @example
 * ```typescript
...
export const csvdiffPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) csvdiff' as const,
  /**
  ...
  fullPath: 'github.com/aswinkarthik/csvdiff' as const,
}
