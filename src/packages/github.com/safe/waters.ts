/**
 * **github.com/safe-waters** - pkgx package
 *
 * @domain `github.com/safe/waters`
 *
 * @install `pkgx github.com/safe-waters`
 * @name `safe-waters`
 * @aliases `github.com/safe-waters`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcomsafewaters
 ...
 */
export const githubcomsafewatersPackage = {
  /**
...
export type GithubcomsafewatersPackage = typeof githubcomsafewatersPackage
