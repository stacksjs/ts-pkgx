/**
 * **github.com/zsh-users** - pkgx package
 *
 * @domain `github.com/zsh/users`
 *
 * @install `pkgx github.com/zsh-users`
 * @name `zsh-users`
 * @aliases `github.com/zsh-users`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcomzshusers
 ...
 */
export const githubcomzshusersPackage = {
  /**
...
export type GithubcomzshusersPackage = typeof githubcomzshusersPackage
