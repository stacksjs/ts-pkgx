/**
 * **python-pathspec** - Package from pantry: github.com/cpburnz/python-pathspec
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/cpburnz/python-..."
 * ```
 *
...
export const githubcomcpburnzpythonpathspecPackage = {
   ...
   */
  description: 'Package from pantry: github.com/cpburnz/python-pathspec' as const,
  /**
