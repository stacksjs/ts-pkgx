 ...
 *
 * @install `sh <(curl https://pkgx.sh) checkmake`
 * @name `checkmake`
 * @aliases `mrtazz/checkmake`
 *
 * @example
 * ```typescript
...
export const checkmakePackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) checkmake' as const,
  /**
  ...
  fullPath: 'github.com/mrtazz/checkmake' as const,
}
