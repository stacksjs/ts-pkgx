/**
 * **github.com/mamba-org** - pkgx package
 *
 * @domain `github.com/mamba/org`
 *
 * @install `pkgx github.com/mamba-org`
 * @name `mamba-org`
 * @aliases `github.com/mamba-org`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcommambaorg
 ...
 */
export const githubcommambaorgPackage = {
  /**
...
export type GithubcommambaorgPackage = typeof githubcommambaorgPackage
