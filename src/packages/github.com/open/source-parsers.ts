 ...
 * const pkg = pantry.githubcomopensourceparsers
 ...
 */
export const githubcomopensourceparsersPackage = {
  /**
...
export type GithubcomopensourceparsersPackage = typeof githubcomopensourceparsersPackage
