 ...
 *
 * @install `sh <(curl https://pkgx.sh) confd`
 * @name `confd`
 * @aliases `abtreece/confd`
 *
 * @example
 * ```typescript
...
export const confdPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) confd' as const,
  /**
  ...
  fullPath: 'github.com/abtreece/confd' as const,
}
