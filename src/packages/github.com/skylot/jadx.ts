/**
 * **jadx** - Package from pantry: github.com/skylot/jadx
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/skylot/jadx"
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/github-com/skylot/jadx.md
 * @see https://ts-pkgx.netlify.app/usage
 */
export const githubcomskylotjadxPackage = {
  /**
   ...
   */
  description: 'Package from pantry: github.com/skylot/jadx' as const,
  /**
...
export type GithubcomskylotjadxPackage = typeof githubcomskylotjadxPackage
