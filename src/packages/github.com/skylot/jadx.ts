 ...
 *
 * @install `sh <(curl https://pkgx.sh) +github.com/skylot/jadx -- $SHELL -i`
 * @name `jadx`
 * @aliases `skylot/jadx`
...
export const jadxPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +github.com/skylot/jadx -- $SHELL -i' as const,
  /**
  ...
  fullPath: 'github.com/skylot/jadx' as const,
}
