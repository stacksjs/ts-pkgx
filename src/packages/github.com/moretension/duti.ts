/**
 * **duti** - Package from pantry: github.com/moretension/duti
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/moretension/duti"
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/github-com/moretension/duti.md
 * @see https://ts-pkgx.netlify.app/usage
 */
export const githubcommoretensiondutiPackage = {
  /**
   ...
   */
  description: 'Package from pantry: github.com/moretension/duti' as const,
  /**
...
export type GithubcommoretensiondutiPackage = typeof githubcommoretensiondutiPackage
