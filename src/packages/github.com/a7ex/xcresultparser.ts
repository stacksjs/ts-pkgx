 ...
 *
 * @install `sh <(curl https://pkgx.sh) xcresultparser`
 * @name `xcresultparser`
 * @aliases `a7ex/xcresultparser`
 *
 * @example
 * ```typescript
...
export const xcresultparserPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) xcresultparser' as const,
  /**
  ...
  fullPath: 'github.com/a7ex/xcresultparser' as const,
}
