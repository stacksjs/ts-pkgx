 ...
 *
 * @install `sh <(curl https://pkgx.sh) redis_tui`
 * @name `redis_tui`
 * @aliases `mat2cc/redis_tui`
 *
 * @example
 * ```typescript
...
export const redistuiPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) redis_tui' as const,
  /**
  ...
  fullPath: 'github.com/mat2cc/redis_tui' as const,
}
