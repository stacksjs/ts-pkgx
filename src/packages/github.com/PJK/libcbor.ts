/**
 * **libcbor** - Package from pantry: github.com/PJK/libcbor
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/PJK/libcbor"
 * ```
 *
...
export const githubcompjklibcborPackage = {
   ...
   */
  description: 'Package from pantry: github.com/PJK/libcbor' as const,
  /**
