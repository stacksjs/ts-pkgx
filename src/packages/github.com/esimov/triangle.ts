 ...
 *
 * @install `sh <(curl https://pkgx.sh) triangle`
 * @name `triangle`
 * @aliases `esimov/triangle`
 *
 * @example
 * ```typescript
...
export const trianglePackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) triangle' as const,
  /**
  ...
  fullPath: 'github.com/esimov/triangle' as const,
}
