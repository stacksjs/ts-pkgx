 ...
 *
 * @install `sh <(curl https://pkgx.sh) spacer`
 * @name `spacer`
 * @aliases `samwho/spacer`
 *
 * @example
 * ```typescript
...
export const spacerPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) spacer' as const,
  /**
  ...
  fullPath: 'github.com/samwho/spacer' as const,
}
