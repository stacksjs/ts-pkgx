 ...
 * const pkg = pantry.githubcomterraformlinters
 ...
 */
export const githubcomterraformlintersPackage = {
  /**
...
export type GithubcomterraformlintersPackage = typeof githubcomterraformlintersPackage
