/**
 * **github.com/coqui-ai** - pkgx package
 *
 * @domain `github.com/coqui/ai`
 *
 * @install `pkgx github.com/coqui-ai`
 * @name `coqui-ai`
 * @aliases `github.com/coqui-ai`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcomcoquiai
 ...
 */
export const githubcomcoquiaiPackage = {
  /**
...
export type GithubcomcoquiaiPackage = typeof githubcomcoquiaiPackage
