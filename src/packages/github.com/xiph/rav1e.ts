/**
 * **rav1e** - Package from pantry: github.com/xiph/rav1e
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/xiph/rav1e"
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/github-com/xiph/rav1e.md
 * @see https://ts-pkgx.netlify.app/usage
 */
export const githubcomxiphrav1ePackage = {
  /**
   ...
   */
  description: 'Package from pantry: github.com/xiph/rav1e' as const,
  /**
...
export type Githubcomxiphrav1ePackage = typeof githubcomxiphrav1ePackage
