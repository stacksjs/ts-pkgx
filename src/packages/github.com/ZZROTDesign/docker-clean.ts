/**
 * **docker-clean** - Package from pantry: github.com/ZZROTDesign/docker-clean
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/ZZROTDesign/doc..."
 * ```
 *
...
export const githubcomzzrotdesigndockercleanPackage = {
   ...
   */
  description: 'Package from pantry: github.com/ZZROTDesign/docker-clean' as const,
  /**
