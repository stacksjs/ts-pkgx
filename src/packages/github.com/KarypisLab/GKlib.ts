/**
 * **GKlib** - Package from pantry: github.com/KarypisLab/GKlib
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/KarypisLab/GKlib"
 * ```
 *
...
export const githubcomkarypislabgklibPackage = {
   ...
   */
  description: 'Package from pantry: github.com/KarypisLab/GKlib' as const,
  /**
