/**
 * **github.com/asciidoc-py** - pkgx package
 *
 * @domain `github.com/asciidoc/py`
 *
 * @install `pkgx github.com/asciidoc-py`
 * @name `asciidoc-py`
 * @aliases `github.com/asciidoc-py`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcomasciidocpy
 ...
 */
export const githubcomasciidocpyPackage = {
  /**
...
export type GithubcomasciidocpyPackage = typeof githubcomasciidocpyPackage
