/**
 * **github.com/asciidoc-py/asciidoc-py** - pkgx package
 *
 * @domain `github.com/asciidoc/py/asciidoc-py`
 *
 * @install `pkgx github.com/asciidoc-py/asciidoc-py`
 * @aliases `github.com/asciidoc-py/asciidoc-py`, `asciidoc-py/asciidoc-py`
 *
 * @example
 * ```typescript
...
export const githubcomasciidocpyasciidocpyPackage = {
   ...
   */
  installCommand: 'pkgx github.com/asciidoc-py/asciidoc-py' as const,
  programs: [] as const,
  companions: [] as const,
