 ...
 *
 * @install `sh <(curl https://pkgx.sh) invoice`
 * @name `invoice`
 * @aliases `maaslalani/invoice`
 *
 * @example
 * ```typescript
...
export const invoicePackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) invoice' as const,
  /**
  ...
  fullPath: 'github.com/maaslalani/invoice' as const,
}
