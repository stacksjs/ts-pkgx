 ...
 *
 * @install `sh <(curl https://pkgx.sh) sparsecat`
 * @name `sparsecat`
 * @aliases `svenwiltink/sparsecat`
 *
 * @example
 * ```typescript
...
export const sparsecatPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) sparsecat' as const,
  /**
  ...
  fullPath: 'github.com/svenwiltink/sparsecat' as const,
}
