 ...
 * @programs `fzf`
 * @version `0.62.0` (45 versions available)
 * @versions From newest version to oldest.
 *
 * @install `sh <(curl https://pkgx.sh) fzf`
 * @name `fzf`
 * @aliases `junegunn/fzf`
 *
 * @example
 * ```typescript
...
export const fzfPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) fzf' as const,
  /**
  ...
  fullPath: 'github.com/junegunn/fzf' as const,
}
