 ...
 *
 * @install `sh <(curl https://pkgx.sh) license`
 * @name `license`
 * @aliases `nishanths/license`
 *
 * @example
 * ```typescript
...
export const licensePackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) license' as const,
  /**
  ...
  fullPath: 'github.com/nishanths/license' as const,
}
