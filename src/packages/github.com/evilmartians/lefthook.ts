 ...
 * @programs `lefthook`
 * @version `1.11.14` (115 versions available)
 * @versions From newest version to oldest.
 *
 * @install `sh <(curl https://pkgx.sh) lefthook`
 * @name `lefthook`
 * @aliases `evilmartians/lefthook`
 *
 * @example
 * ```typescript
...
export const lefthookPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) lefthook' as const,
  /**
  ...
  fullPath: 'github.com/evilmartians/lefthook' as const,
}
