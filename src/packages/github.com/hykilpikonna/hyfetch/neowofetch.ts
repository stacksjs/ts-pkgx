 ...
 *
 * @install `sh <(curl https://pkgx.sh) neowofetch`
 * @name `neowofetch`
 * @aliases `hykilpikonna/hyfetch/neowofetch`
...
export const neowofetchPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) neowofetch' as const,
  /**
   ...
   */
  aliases: [
    'hykilpikonna/hyfetch/neowofetch',
  ] as const,
  fullPath: 'github.com/hykilpikonna/hyfetch/neowofetch' as const,
}
