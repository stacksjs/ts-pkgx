 ...
 *
 * @install `sh <(curl https://pkgx.sh) hyfetch`
 * @name `hyfetch`
 * @aliases `hykilpikonna/hyfetch`
...
export const hyfetchPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) hyfetch' as const,
  /**
  ...
  fullPath: 'github.com/hykilpikonna/hyfetch' as const,
}
