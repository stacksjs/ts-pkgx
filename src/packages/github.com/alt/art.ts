/**
 * **github.com/alt-art** - pkgx package
 *
 * @domain `github.com/alt/art`
 *
 * @install `pkgx github.com/alt-art`
 * @name `alt-art`
 * @aliases `github.com/alt-art`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcomaltart
 ...
 */
export const githubcomaltartPackage = {
  /**
...
export type GithubcomaltartPackage = typeof githubcomaltartPackage
