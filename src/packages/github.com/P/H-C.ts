/**
 * **github.com/P-H-C** - pkgx package
 *
 * @domain `github.com/P/H-C`
 *
 * @install `pkgx github.com/P-H-C`
 * @name `P-H-C`
 * @aliases `github.com/P-H-C`
 *
 * @example
 * ```typescript
 ...
 */
export const githubcomPHCPackage = {
  /**
...
export type GithubcomPHCPackage = typeof githubcomPHCPackage
