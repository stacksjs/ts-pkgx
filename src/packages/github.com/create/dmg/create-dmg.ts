/**
 * **github.com/create-dmg/create-dmg** - pkgx package
 *
 * @domain `github.com/create/dmg/create-dmg`
 *
 * @install `pkgx github.com/create-dmg/create-dmg`
 * @aliases `github.com/create-dmg/create-dmg`, `create-dmg/create-dmg`
 *
 * @example
 * ```typescript
...
export const githubcomcreatedmgcreatedmgPackage = {
   ...
   */
  installCommand: 'pkgx github.com/create-dmg/create-dmg' as const,
  programs: [] as const,
  companions: [] as const,
