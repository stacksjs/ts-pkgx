/**
 * **github.com/sekrit-twc** - pkgx package
 *
 * @domain `github.com/sekrit/twc`
 *
 * @install `pkgx github.com/sekrit-twc`
 * @name `sekrit-twc`
 * @aliases `github.com/sekrit-twc`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcomsekrittwc
 ...
 */
export const githubcomsekrittwcPackage = {
  /**
...
export type GithubcomsekrittwcPackage = typeof githubcomsekrittwcPackage
