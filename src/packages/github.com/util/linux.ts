/**
 * **github.com/util-linux** - pkgx package
 *
 * @domain `github.com/util/linux`
 *
 * @install `pkgx github.com/util-linux`
 * @name `util-linux`
 * @aliases `github.com/util-linux`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.githubcomutillinux
 ...
 */
export const githubcomutillinuxPackage = {
  /**
...
export type GithubcomutillinuxPackage = typeof githubcomutillinuxPackage
