 ...
 *
 * @install `sh <(curl https://pkgx.sh) k3sup`
 * @name `k3sup`
 * @aliases `alexellis/k3sup`
 *
 * @example
 * ```typescript
...
export const k3supPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) k3sup' as const,
  /**
  ...
  fullPath: 'github.com/alexellis/k3sup' as const,
}
