/**
 * **rusty-kaspa** - Package from pantry: github.com/kaspanet/rusty-kaspa
 *
 ...
 * console.log(pkg.description) // "Package from pantry: github.com/kaspanet/rusty-..."
 * ```
 *
...
export const githubcomkaspanetrustykaspaPackage = {
   ...
   */
  description: 'Package from pantry: github.com/kaspanet/rusty-kaspa' as const,
  /**
