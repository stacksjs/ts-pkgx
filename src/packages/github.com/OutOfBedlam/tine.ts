 ...
 *
 * @install `sh <(curl https://pkgx.sh) tine`
 * @name `tine`
 * @aliases `OutOfBedlam/tine`
 *
 * @example
 * ```typescript
...
export const tinePackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) tine' as const,
  /**
  ...
  fullPath: 'github.com/OutOfBedlam/tine' as const,
}
