 ...
 *
 * @install `sh <(curl https://pkgx.sh) sqlboiler`
 * @name `sqlboiler`
 * @aliases `volatiletech/sqlboiler`
 *
 * @example
 * ```typescript
...
export const sqlboilerPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) sqlboiler' as const,
  /**
  ...
  fullPath: 'github.com/volatiletech/sqlboiler' as const,
}
