 ...
 *
 * @install `sh <(curl https://pkgx.sh) tfupdate`
 * @name `tfupdate`
 * @aliases `minamijoyo/tfupdate`
 *
 * @example
 * ```typescript
...
export const tfupdatePackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) tfupdate' as const,
  /**
  ...
  fullPath: 'github.com/minamijoyo/tfupdate' as const,
}
