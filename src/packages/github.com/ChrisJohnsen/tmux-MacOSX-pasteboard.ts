 ...
 *
 * @install `sh <(curl https://pkgx.sh) reattach-to-user-namespace`
 * @name `reattach-to-user-namespace`
 * @aliases `ChrisJohnsen/tmux-MacOSX-pasteboard`
 *
 * @example
 * ```typescript
...
export const reattachtousernamespacePackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) reattach-to-user-namespace' as const,
  /**
