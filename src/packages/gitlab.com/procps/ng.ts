/**
 * **gitlab.com/procps-ng** - pkgx package
 *
 * @domain `gitlab.com/procps/ng`
 *
 * @install `pkgx gitlab.com/procps-ng`
 * @name `procps-ng`
 * @aliases `gitlab.com/procps-ng`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.gitlabcomprocpsng
 ...
 */
export const gitlabcomprocpsngPackage = {
  /**
...
export type GitlabcomprocpsngPackage = typeof gitlabcomprocpsngPackage
