/**
 * **procps** - Package from pantry: gitlab.com/procps-ng/procps
 *
 ...
 * console.log(pkg.description) // "Package from pantry: gitlab.com/procps-ng/procps"
 * ```
 *
...
export const gitlabcomprocpsngprocpsPackage = {
   ...
   */
  description: 'Package from pantry: gitlab.com/procps-ng/procps' as const,
  /**
