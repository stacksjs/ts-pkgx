/**
 * **gitlab.com/gitlab-org** - pkgx package
 *
 * @domain `gitlab.com/gitlab/org`
 *
 * @install `pkgx gitlab.com/gitlab-org`
 * @name `gitlab-org`
 * @aliases `gitlab.com/gitlab-org`
 *
 * @example
 * ```typescript
 ...
 * const pkg = pantry.gitlabcomgitlaborg
 ...
 */
export const gitlabcomgitlaborgPackage = {
  /**
...
export type GitlabcomgitlaborgPackage = typeof gitlabcomgitlaborgPackage
