 ...
 *
 * // Access the package
 * const pkg = pantry.kubernetessigs
 ...
 */
export const kubernetessigsPackage = {
  /**
   ...
   */
  description: 'A package from github.com/kubernetes-sigs' as const,
...
export type KubernetessigsPackage = typeof kubernetessigsPackage
