/**
 * **+openexr.com -- $SHELL -i** - The OpenEXR project provides the specification and reference implementation of the EXR file format, the professional-grade image storage format of the motion picture industry.
 *
 * @domain `openexr.com`
 ...
 * const pkg = pantry.openexrcomSHELLi
 ...
 */
export const openexrcomSHELLiPackage = {
  /**
...
export type OpenexrcomSHELLiPackage = typeof openexrcomSHELLiPackage
