...
/**
 * grpcioPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const grpcioPackage: PkgxPackage = {
  name: "grpc",
  domain: "grpc.io",
  ...
  installCommand: "sh <(curl https://pkgx.sh) +grpc.io -- $SHELL -i",
  programs: [
    "grpc_csharp_plugin",
    "grpc_node_plugin",
    "grpc_cpp_plugin",
...
export interface GrpcioPackage {
  ...
  name: "grpc.io";
  domain: "grpc.io";
  description: "Package information for grpc.io";
}