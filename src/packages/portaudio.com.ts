/**
 * **+portaudio.com -- $SHELL -i** - PortAudio is a cross-platform, open-source C language library for real-time audio input and output.
 *
 ...
 * const pkg = pantry.portaudiocomSHELLi
 ...
 */
export const portaudiocomSHELLiPackage = {
  /**
...
export type PortaudiocomSHELLiPackage = typeof portaudiocomSHELLiPackage
