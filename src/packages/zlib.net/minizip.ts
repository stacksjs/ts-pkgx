 ...
 *
 * @install `sh <(curl https://pkgx.sh) +zlib.net/minizip -- $SHELL -i`
 * @aliases `minizip`
 *
 * @example
 * ```typescript
 ...
 * const samePkg = pantry.zlibnetminizip
...
export const minizipPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +zlib.net/minizip -- $SHELL -i' as const,
  programs: [] as const,
  companions: [] as const,
  ...
  fullPath: 'zlib.net/minizip' as const,
}

export type MinizipPackage = typeof minizipPackage
