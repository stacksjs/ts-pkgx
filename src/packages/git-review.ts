 ...
 *
 * @install `sh <(curl https://pkgx.sh) git-review`
 * @name `git-review`
...
export const gitreviewPackage = {
   ...
   */
  description: 'A package from opendev.org/git-review' as const,
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) git-review' as const,
  /**
