 ...
 * @dependencies `go.dev@^1.23`, `linux:gnu.org/gcc`, `linux:gnu.org/binutils` (includes OS-specific dependencies with `os:package` format)
 *
 * @example
 * ```typescript
 ...
 * console.log(pkg.versions[0]) // "2.49.1" (latest)
 * ```
 *
