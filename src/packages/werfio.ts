...
/**
 * werfioPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const werfioPackage: PkgxPackage = {
  name: "werf",
  domain: "werf.io",
  ...
  packageYmlUrl: "https://github.com/pkgxdev/pantry/tree/main/projects/werf.io/package.yml",
  homepageUrl: "",
  githubUrl: "https://github.com/pkgxdev/pantry/",
  installCommand: "sh <(curl https://pkgx.sh) werf",
  programs: ["werf"],
  companions: [],
  dependencies: [
...
export interface WerfioPackage {
  ...
  name: "werf.io";
  domain: "werf.io";
  description: "Package information for werf.io";
}