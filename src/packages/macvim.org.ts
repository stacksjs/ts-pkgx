/**
 * **+macvim.org -- $SHELL -i** - Vim - the text editor - for macOS
 *
 * @domain `macvim.org`
 ...
 * const pkg = pantry.macvimorgSHELLi
 * // Or access via domain
 * const samePkg = pantry.macvimorg
 ...
 */
export const macvimorgSHELLiPackage = {
  /**
...
export type MacvimorgSHELLiPackage = typeof macvimorgSHELLiPackage
