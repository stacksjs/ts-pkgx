...
/**
 * erlangorgPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const erlangorgPackage: PkgxPackage = {
  name: "erlang.org",
  domain: "erlang.org",
  ...
  installCommand: "sh <(curl https://pkgx.sh) +erlang.org -- $SHELL -i",
  programs: [
    "ct_run",
    "dialyzer",
    "epmd",
...
export interface ErlangorgPackage {
  ...
  name: "erlang.org";
  domain: "erlang.org";
  description: "Package information for erlang.org";
}
