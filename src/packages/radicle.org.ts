/**
 * **+radicle.org -- $SHELL -i** - Radicle CLI
 *
 * @domain `radicle.org`
 ...
 * const pkg = pantry.radicleorgSHELLi
 * // Or access via domain
 * const samePkg = pantry.radicleorg
 ...
 */
export const radicleorgSHELLiPackage = {
  /**
...
export type RadicleorgSHELLiPackage = typeof radicleorgSHELLiPackage
