 ...
 * @version `3.0.68` (20 versions available)
 * @versions From newest version to oldest.
 * @see https://ts-pkgx.netlify.app/packages/swagger-io/swagger-codegen.md
 *
 * @install `sh <(curl https://pkgx.sh) swagger-codegen`
 ...
 * console.log(pkg.versions[0]) // "3.0.68" (latest)
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/swagger-io/swagger-codegen.md
...
export const swaggercodegenPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) swagger-codegen' as const,
  /**
