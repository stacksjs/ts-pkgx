 ...
 *
 * @install `sh <(curl https://pkgx.sh) +gnupg.org/pinentry -- $SHELL -i`
 * @name `pinentry`
...
export const pinentryPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +gnupg.org/pinentry -- $SHELL -i' as const,
  /**
   ...
   */
  aliases: [] as const,
  fullPath: 'gnupg.org/pinentry' as const,
}
