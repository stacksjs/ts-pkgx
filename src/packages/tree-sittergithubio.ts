...
/**
 * treesittergithubioPackage information from pkgx.dev
...
export interface TreesittergithubioPackage {
  ...
  versions: readonly [];
  name: "tree/sittergithubio";
  domain: "tree/sittergithubio";
  description: "Package information for tree/sittergithubio";
}