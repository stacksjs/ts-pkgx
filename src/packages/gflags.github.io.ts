/**
 * **+gflags.github.io -- $SHELL -i** - The gflags package contains a C++ library that implements commandline flags processing. It includes built-in support for standard types such as string and the ability to define flags in the source file in which they are used. Online documentation available at:
 *
 ...
 * const pkg = pantry.gflagsgithubioSHELLi
 * // Or access via domain
 * const samePkg = pantry.gflagsgithubio
 ...
 */
export const gflagsgithubioSHELLiPackage = {
  /**
...
export type GflagsgithubioSHELLiPackage = typeof gflagsgithubioSHELLiPackage
