 ...
 *
 * @install `sh <(curl https://pkgx.sh) xauth`
 * @name `xauth`
 * @dependencies `x.org/x11`, `x.org/exts`, `x.org/xau`, ... (+4 more)
 *
 * @example
 * ```typescript
...
export const xauthPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) xauth' as const,
  /**
