/**
 * **+lua.org -- $SHELL -i** - Powerful, lightweight programming language
 *
 * @domain `lua.org`
 * @programs `lua`, `luac`
 ...
 * console.log(pkg.versions[0]) // "5.4.7" (latest)
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/lua-org.md
 * @see https://ts-pkgx.netlify.app/usage
 */
export const luaorgSHELLiPackage = {
  /**
...
export type LuaorgSHELLiPackage = typeof luaorgSHELLiPackage
