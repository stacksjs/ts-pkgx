...
/**
 * qtioPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const qtioPackage: PkgxPackage = {
  name: "qt.io",
  domain: "qt.io",
  description: "",
  ...
  installCommand: "sh <(curl https://pkgx.sh) +qt.io -- $SHELL -i",
  programs: [
    "balsam",
    "canbusutil",
    "lconvert",
...
export interface QtioPackage {
  ...
  name: "qt.io";
  domain: "qt.io";
  description: "Package information for qt.io";
}