/**
 * **PyGObject** - Package from pantry: gnome.org/PyGObject
 *
 ...
 * console.log(pkg.description) // "Package from pantry: gnome.org/PyGObject"
 * ```
 *
...
export const gnomeorgpygobjectPackage = {
   ...
   */
  description: 'Package from pantry: gnome.org/PyGObject' as const,
  /**
