/**
 * **gi-docgen** - Package from pantry: gnome.org/gi-docgen
 *
 ...
 * console.log(pkg.description) // "Package from pantry: gnome.org/gi-docgen"
 * ```
 *
...
export const gnomeorggidocgenPackage = {
   ...
   */
  description: 'Package from pantry: gnome.org/gi-docgen' as const,
  /**
