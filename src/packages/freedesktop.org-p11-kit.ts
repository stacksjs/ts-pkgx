 ...
 *
 * @install `sh <(curl https://pkgx.sh) +freedesktop.org/p11-kit -- $SHELL -i`
 * @aliases `p11-kit`
...
export const p11kitPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +freedesktop.org/p11-kit -- $SHELL -i' as const,
  /**
...
export type P11kitPackage = typeof p11kitPackage
