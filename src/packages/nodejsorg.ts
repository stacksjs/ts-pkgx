...
/**
 * nodejsorgPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const nodejsorgPackage: PkgxPackage = {
  name: "node",
  domain: "nodejs.org",
  ...
  installCommand: "sh <(curl https://pkgx.sh) node",
  programs: ["node"],
...
export interface NodejsorgPackage {
  programs: readonly [];
  companions: readonly [];
  ...
  name: "nodejs.org";
  domain: "nodejs.org";
  description: "Package information for nodejs.org";
}