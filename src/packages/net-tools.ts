 ...
 *
 * @domain `sf.net/net-tools`
 * @programs `hostname`, `ifconfig`, `netstat`, `route`
 * @version `2.10.0` (1 versions available)
 * @versions From newest version to oldest.
 * @see https://ts-pkgx.netlify.app/packages/sf-net/net-tools.md
 *
 * @install `sh <(curl https://pkgx.sh) +sourceforge.net/net-tools -- $SHELL -i`
 * @name `net-tools`
 ...
 * const samePkg = pantry.sfnetnettools
...
export const nettoolsPackage = {
   ...
   */
  domain: 'sf.net/net-tools' as const,
  /**
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +sourceforge.net/net-tools -- $SHELL -i' as const,
  /**
