/**
 * **+gts.sourceforge.net -- $SHELL -i** - GNU triangulated surface library
 *
 ...
 * const pkg = pantry.gtssourceforgenetSHELLi
 * // Or access via domain
 * const samePkg = pantry.gtssourceforgenet
 ...
 */
export const gtssourceforgenetSHELLiPackage = {
  /**
...
export type GtssourceforgenetSHELLiPackage = typeof gtssourceforgenetSHELLiPackage
