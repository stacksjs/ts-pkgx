/**
 * **gl2ps** - Package from pantry: geuz.org/gl2ps
 *
 ...
 * console.log(pkg.description) // "Package from pantry: geuz.org/gl2ps"
 * ```
 *
...
export const geuzorggl2psPackage = {
   ...
   */
  description: 'Package from pantry: geuz.org/gl2ps' as const,
  /**
