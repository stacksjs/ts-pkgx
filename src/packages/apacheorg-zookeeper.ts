import type { apacheorgzookeeperPackage } from '../types'

/**
 * apacheorgzookeeperPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const apacheorgzookeeperPackage: apacheorgzookeeperPackage = {
