 ...
 * @programs `typos`
 * @version `1.33.1` (100 versions available)
 * @versions From newest version to oldest.
 * @see https://ts-pkgx.netlify.app/packages/crates-io/typos.md
 *
 * @install `sh <(curl https://pkgx.sh) typos`
 * @name `typos`
 *
 * @example
 * ```typescript
...
export const typosPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) typos' as const,
  /**
   ...
   */
  aliases: [] as const,
  fullPath: 'crates.io/typos' as const,
}
