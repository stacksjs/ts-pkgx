/**
 * **+openjdk.org -- $SHELL -i** - Development kit for the Java programming language
 *
 * @domain `openjdk.org`
 ...
 * const pkg = pantry.openjdkorgSHELLi
 ...
 */
export const openjdkorgSHELLiPackage = {
  /**
...
export type OpenjdkorgSHELLiPackage = typeof openjdkorgSHELLiPackage
