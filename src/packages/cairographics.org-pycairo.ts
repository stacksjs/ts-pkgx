 ...
 *
 * @install `sh <(curl https://pkgx.sh) +cairographics.org/pycairo -- $SHELL -i`
 * @aliases `pycairo`
 ...
 * const samePkg = pantry.cairographicsorgpycairo
...
export const pycairoPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +cairographics.org/pycairo -- $SHELL -i' as const,
  programs: [] as const,
  companions: [] as const,
  /**
  ...
  fullPath: 'cairographics.org/pycairo' as const,
}

export type PycairoPackage = typeof pycairoPackage
