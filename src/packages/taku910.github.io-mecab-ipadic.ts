 ...
 *
 * @install `sh <(curl https://pkgx.sh) +taku910.github.io/mecab-ipadic -- $SHELL -i`
...
export const mecabipadicPackage = {
   ...
   */
  description: 'A package from taku910.github.io/mecab-ipadic' as const,
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +taku910.github.io/mecab-ipadic -- $SHELL -i' as const,
  programs: [] as const,
  companions: [] as const,
  /**
