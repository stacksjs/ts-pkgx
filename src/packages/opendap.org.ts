/**
 * **+opendap.org -- $SHELL -i** - A new version of libdap that contains both DAP2 and DAP4 support
 *
 * @domain `opendap.org`
 ...
 * const pkg = pantry.opendaporgSHELLi
 * // Or access via domain
 * const samePkg = pantry.opendaporg
 ...
 */
export const opendaporgSHELLiPackage = {
  /**
...
export type OpendaporgSHELLiPackage = typeof opendaporgSHELLiPackage
