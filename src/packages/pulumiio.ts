...
/**
 * pulumiioPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const pulumiioPackage: PkgxPackage = {
  name: "pulumi",
  domain: "pulumi.io",
  ...
  installCommand: "sh <(curl https://pkgx.sh) +pulumi.io -- $SHELL -i",
  programs: [
    "pulumi",
...
export interface PulumiioPackage {
  ...
  name: "pulumi.io";
  domain: "pulumi.io";
  description: "Package information for pulumi.io";
}
