/**
 * **+lunarvim.org -- $SHELL -i** - 🌙 LunarVim is an IDE layer for Neovim. Completely free and community driven.
 *
 * @domain `lunarvim.org`
 * @programs `lvim`, `nvim`
 ...
 * const pkg = pantry.lunarvimorgSHELLi
 * // Or access via domain
 * const samePkg = pantry.lunarvimorg
 ...
 */
export const lunarvimorgSHELLiPackage = {
  /**
...
export type LunarvimorgSHELLiPackage = typeof lunarvimorgSHELLiPackage
