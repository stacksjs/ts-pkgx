/**
 * **+hurl.dev -- $SHELL -i** - Run and Test HTTP Requests with plain text and curl
 *
 * @domain `hurl.dev`
 ...
 * const pkg = pantry.hurldevSHELLi
 ...
 */
export const hurldevSHELLiPackage = {
  /**
...
export type HurldevSHELLiPackage = typeof hurldevSHELLiPackage
