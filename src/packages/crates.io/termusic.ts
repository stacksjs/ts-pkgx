/**
 * **termusic** - Package from pantry: crates.io/termusic
 *
 ...
 * console.log(pkg.description) // "Package from pantry: crates.io/termusic"
 * ```
 *
...
export const cratesiotermusicPackage = {
   ...
   */
  description: 'Package from pantry: crates.io/termusic' as const,
  /**
