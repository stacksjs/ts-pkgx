 ...
 * @programs `broot`
 * @version `1.50.0` (65 versions available)
...
export const brootPackage = {
   ...
   */
  aliases: [] as const,
  pkgxInstallCommand: 'sh <(curl https://pkgx.sh) broot -- $SHELL -i' as const,
  launchpadInstallCommand: 'launchpad install broot' as const,
}
