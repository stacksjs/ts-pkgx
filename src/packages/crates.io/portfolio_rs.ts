 ...
 * @version `0.5.0` (11 versions available)
...
export const portfoliorsPackage = {
   ...
   */
  aliases: [] as const,
  pkgxInstallCommand: 'sh <(curl https://pkgx.sh) portfolio_rs -- $SHELL -i' as const,
  launchpadInstallCommand: 'launchpad install portfolio_rs' as const,
}
