 ...
 *
 * @install `sh <(curl https://pkgx.sh) +crates.io/pueue -- $SHELL -i`
 * @name `pueue`
 *
 * @example
 * ```typescript
...
export const pueuePackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +crates.io/pueue -- $SHELL -i' as const,
  /**
   ...
   */
  aliases: [] as const,
  fullPath: 'crates.io/pueue' as const,
}
