/**
 * **pier** - Package from pantry: crates.io/pier
 *
 ...
 * console.log(pkg.description) // "Package from pantry: crates.io/pier"
 * ```
 *
...
export const cratesiopierPackage = {
   ...
   */
  description: 'Package from pantry: crates.io/pier' as const,
  /**
