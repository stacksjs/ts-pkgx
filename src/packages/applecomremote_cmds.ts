import type { applecomremote_cmdsPackage } from '../types'

/**
 * applecomremote_cmdsPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const applecomremote_cmdsPackage: applecomremote_cmdsPackage = {
  name: 'telnet',
...
export interface applecomremote_cmdsPackage {
  ...
  fullPath: 'apple.com/remote_cmds'
  aliases: readonly ['telnet', 'remote_cmds']
}
