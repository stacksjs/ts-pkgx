 ...
 * @programs `talhelper`
 * @version `3.0.29` (49 versions available)
 * @versions From newest version to oldest.
 *
 * @install `sh <(curl https://pkgx.sh) talhelper`
 * @name `talhelper`
 *
 * @example
 * ```typescript
 ...
 * console.log(pkg.versions[0]) // "3.0.29" (latest)
 * ```
 *
...
export const talhelperPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) talhelper' as const,
  /**
   ...
   */
  aliases: [] as const,
  fullPath: 'budimanjojo.github.io/talhelper' as const,
}
