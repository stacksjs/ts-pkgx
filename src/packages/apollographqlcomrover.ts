import type { apollographqlcomroverPackage } from '../types'

/**
 * apollographqlcomroverPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const apollographqlcomroverPackage: apollographqlcomroverPackage = {
  "name": "rover",
