import type { terraformioPackage } from '../types'

/**
 * terraformioPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const terraformioPackage: terraformioPackage = {
  "name": "terraform",
  "domain": "terraform.io",
  ...
  "packageYmlUrl": "https://github.com/pkgxdev/pantry/tree/main/projects/terraform.io/package.yml",
  "homepageUrl": "",
  "githubUrl": "https://github.com/pkgxdev/pantry/",
  "installCommand": "sh <(curl https://pkgx.sh) terraform",
  "programs": [
    "terraform"
  ],
  "companions": [],
