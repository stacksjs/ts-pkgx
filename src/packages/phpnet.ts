...
/**
 * phpnetPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const phpnetPackage: PkgxPackage = {
  name: "php.net",
  domain: "php.net",
  description: "General-purpose scripting language",
  packageYmlUrl: "https://github.com/pkgxdev/pantry/tree/main/projects/php.net/package.yml",
  homepageUrl: "",
  githubUrl: "https://github.com/pkgxdev/pantry/",
  installCommand: "sh <(curl https://pkgx.sh) +php.net -- $SHELL -i",
  programs: [
    "pear",
    "pecl",
    "phar",
...
export interface PhpnetPackage {
  programs: readonly [];
  companions: readonly [];
  ...
  name: "php.net";
  domain: "php.net";
  description: "Package information for php.net";
}