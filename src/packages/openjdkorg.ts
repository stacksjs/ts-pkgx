...
/**
 * openjdkorgPackage information from pkgx.dev
 * Generated by pkgx-tools
 */
export const openjdkorgPackage: PkgxPackage = {
  name: "openjdk.org",
  domain: "openjdk.org",
  description: "Development kit for the Java programming language",
  packageYmlUrl: "https://github.com/pkgxdev/pantry/tree/main/projects/openjdk.org/package.yml",
  homepageUrl: "",
  githubUrl: "https://github.com/pkgxdev/pantry/",
  installCommand: "sh <(curl https://pkgx.sh) +openjdk.org -- $SHELL -i",
  programs: [
    "jar",
    "jarsigner",
    "java",
...
export interface OpenjdkorgPackage {
  ...
  name: "openjdk.org";
  domain: "openjdk.org";
  description: "Package information for openjdk.org";
}