 ...
 * @versions From newest version to oldest. @see https://ts-pkgx.netlify.app/packages/borgbackup-org.md
 *
...
export const borgPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +borgbackup.org -- $SHELL -i' as const,
  /**
