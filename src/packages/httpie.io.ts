/**
 * **+httpie.io -- $SHELL -i** - 🥧 HTTPie CLI  — modern, user-friendly command-line HTTP client for the API era. JSON support, colors, sessions, downloads, plugins & more.
 *
 * @domain `httpie.io`
 ...
 * const pkg = pantry.httpieioSHELLi
 * // Or access via domain
 * const samePkg = pantry.httpieio
 ...
 */
export const httpieioSHELLiPackage = {
  /**
...
export type HttpieioSHELLiPackage = typeof httpieioSHELLiPackage
