 ...
 * @programs `ruby-build`
 * @version `20250610.0.0` (44 versions available)
 * @versions From newest version to oldest.
 * @see https://ts-pkgx.netlify.app/packages/rbenv-org/ruby-build.md
 *
 * @install `sh <(curl https://pkgx.sh) ruby-build`
 * @name `ruby-build`
 ...
 * console.log(pkg.versions[0]) // "20250610.0.0" (latest)
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/rbenv-org/ruby-build.md
...
export const rubybuildPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) ruby-build' as const,
  /**
