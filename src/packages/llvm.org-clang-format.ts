 ...
 *
 * @install `sh <(curl https://pkgx.sh) +llvm.org/clang-format -- $SHELL -i`
 * @aliases `clang-format`
 ...
 */
export const clangformatPackage = {
  /**
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +llvm.org/clang-format -- $SHELL -i' as const,
  /**
...
export type ClangformatPackage = typeof clangformatPackage
