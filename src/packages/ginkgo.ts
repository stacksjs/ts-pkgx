 ...
 * @programs `ginkgo`
 * @version `2.23.4` (15 versions available)
 * @versions From newest version to oldest.
 * @see https://ts-pkgx.netlify.app/packages/onsi-github-io/ginkgo.md
 *
 * @install `sh <(curl https://pkgx.sh) ginkgo`
 * @name `ginkgo`
 *
 * @example
 * ```typescript
 ...
 * console.log(pkg.versions[0]) // "2.23.4" (latest)
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/onsi-github-io/ginkgo.md
...
export const ginkgoPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) ginkgo' as const,
  /**
   ...
   */
  aliases: [] as const,
  fullPath: 'onsi.github.io/ginkgo' as const,
}
