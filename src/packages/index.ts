...
export interface Pantry {
  ...
  /**
   * **Protocol Buffers** - Protocol Buffers - Google\\
   *
   * @domain `protobuf.dev`
   * @programs `protoc`
   ...
   * console.log(pkg.description) // "Protocol Buffers - Google\"
  ...
  /**
   * **vite** - Next generation frontend tooling. It\\
   *
   * @domain `vitejs.dev`
   * @programs `vite`
   ...
   * console.log(pkg.description) // "Next generation frontend tooling. It\"
  ...
  /**
   * **vcluster** - vCluster - Create fully functional virtual Kubernetes clusters - Each vcluster runs inside a namespace of the underlying k8s cluster. It\\
   *
   * @domain `vcluster.com`
   * @programs `vcluster`
   ...
   * console.log(pkg.description) // "Certbot is EFF\"
   ...
   * console.log(pkg.description) // "World\"
  ...
  /**
   * **mkcert** - A simple zero-config tool to make locally trusted development certificates with any names you\\
   *
   * @domain `mkcert.dev`
   * @programs `mkcert`
  ...
  /**
   * **ladspa.org** - Linux Audio Developer\\
   *
   * @domain `ladspa.org`
   ...
   * console.log(pkg.description) // "Linux Audio Developer\"
  ...
  /**
   * **postgresql.org** - Mirror of the official PostgreSQL GIT repository. Note that this is just a \*mirror\* - we don\\
   *
   ...
   * console.log(pkg.description) // "Home of .NET\"
  ...
  /**
   * **haskell.org** - Mirror of the Glasgow Haskell Compiler. Please submit issues and patches to GHC\\
   *
   * @domain `haskell.org`
   ...
   * console.log(pkg.description) // "Little helper to run CNCF\"
  ...
  /**
   * **mysql.com** - MySQL Server, the world\\
   *
   * @domain `mysql.com`
   ...
   * console.log(pkg.description) // "MySQL Server, the world\"
   ...
   * console.log(pkg.description) // "Substitute for classic \"
