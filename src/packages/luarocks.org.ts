/**
 * **+luarocks.org -- $SHELL -i** - LuaRocks is the package manager for the Lua programming language.
 *
 * @domain `luarocks.org`
 ...
 * const pkg = pantry.luarocksorgSHELLi
 ...
 */
export const luarocksorgSHELLiPackage = {
  /**
...
export type LuarocksorgSHELLiPackage = typeof luarocksorgSHELLiPackage
