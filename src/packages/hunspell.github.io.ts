/**
 * **+hunspell.github.io -- $SHELL -i** - Spell checker and morphological analyzer
 *
 ...
 * const pkg = pantry.hunspellgithubioSHELLi
 ...
 */
export const hunspellgithubioSHELLiPackage = {
  /**
...
export type HunspellgithubioSHELLiPackage = typeof hunspellgithubioSHELLiPackage
