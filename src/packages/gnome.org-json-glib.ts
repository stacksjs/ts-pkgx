 ...
 *
 * @install `sh <(curl https://pkgx.sh) +gnome.org/json-glib -- $SHELL -i`
 * @aliases `json-glib`
...
export const jsonglibPackage = {
   ...
   */
  description: 'A package from gnome.org/json-glib' as const,
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +gnome.org/json-glib -- $SHELL -i' as const,
  programs: [] as const,
  companions: [] as const,
  /**
