/**
 * **gcc/libstdcxx** - pkgx package
 *
 * @domain `gnu.org/gcc/libstdcxx`
 * @version `15.1.0` (6 versions available)
 * @versions From newest version to oldest.
 *
 * @install `sh <(curl https://pkgx.sh) +gnu.org/gcc/libstdcxx -- $SHELL -i`
 * @aliases `gcc/libstdcxx`
 ...
 * const pkg = pantry.gcclibstdcxx
 * // Or access via domain
 * const samePkg = pantry.gnuorggcclibstdcxx
 ...
 */
export const gcclibstdcxxPackage = {
  /**
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) +gnu.org/gcc/libstdcxx -- $SHELL -i' as const,
  programs: [] as const,
  companions: [] as const,
  /**
  ...
  fullPath: 'gnu.org/gcc/libstdcxx' as const,
}

export type GcclibstdcxxPackage = typeof gcclibstdcxxPackage
