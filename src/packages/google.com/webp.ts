/**
 * **webp** - Package from pantry: google.com/webp
 *
 ...
 * console.log(pkg.description) // "Package from pantry: google.com/webp"
 * ```
 *
...
export const googlecomwebpPackage = {
   ...
   */
  description: 'Package from pantry: google.com/webp' as const,
  /**
