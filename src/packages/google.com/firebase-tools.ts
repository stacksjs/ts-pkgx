/**
 * **firebase-tools** - Package from pantry: google.com/firebase-tools
 *
 ...
 * console.log(pkg.description) // "Package from pantry: google.com/firebase-tools"
 * ```
 *
...
export const googlecomfirebasetoolsPackage = {
   ...
   */
  description: 'Package from pantry: google.com/firebase-tools' as const,
  /**
