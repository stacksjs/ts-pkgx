/**
 * **+fly.io -- $SHELL -i** - Command line tools for fly.io services
 *
 * @domain `fly.io`
 * @programs `fly`, `flyctl`
 ...
 * console.log(pkg.versions[0]) // "0.3.135" (latest)
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/fly-io.md
 * @see https://ts-pkgx.netlify.app/usage
 */
export const flyioSHELLiPackage = {
  /**
...
export type FlyioSHELLiPackage = typeof flyioSHELLiPackage
