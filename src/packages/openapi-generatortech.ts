 ...
 */
export const openapigeneratortechPackage: PkgxPackage = {
...
export interface OpenapigeneratortechPackage {
  ...
  versions: readonly [];
  name: "openapi/generatortech";
  domain: "openapi/generatortech";
  description: "Package information for openapi/generatortech";
}