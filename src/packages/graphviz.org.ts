/**
 * **+graphviz.org -- $SHELL -i** - Graph visualization software from AT&T and Bell Labs
 *
 * @domain `graphviz.org`
 ...
 * const pkg = pantry.graphvizorgSHELLi
 * // Or access via domain
 * const samePkg = pantry.graphvizorg
 ...
 */
export const graphvizorgSHELLiPackage = {
  /**
...
export type GraphvizorgSHELLiPackage = typeof graphvizorgSHELLiPackage
