/**
 * **ca-certs** - Package from pantry: curl.se/ca-certs
 *
 ...
 * console.log(pkg.description) // "Package from pantry: curl.se/ca-certs"
 * ```
 *
...
export const curlsecacertsPackage = {
   ...
   */
  description: 'Package from pantry: curl.se/ca-certs' as const,
  /**
