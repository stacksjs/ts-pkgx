 ...
 * @programs `cargo`
 * @version `0.88.0` (26 versions available)
 * @versions From newest version to oldest.
 * @see https://ts-pkgx.netlify.app/packages/rust-lang-org/cargo.md
 *
 * @install `sh <(curl https://pkgx.sh) cargo`
 * @name `cargo`
 * @dependencies `zlib.net^1`, `libgit2.org~1.7`, `curl.se/ca-certs`, ... (+3 more)
 ...
 * console.log(pkg.versions[0]) // "0.88.0" (latest)
 * ```
 *
 * @see https://ts-pkgx.netlify.app/packages/rust-lang-org/cargo.md
...
export const cargoPackage = {
   ...
   */
  installCommand: 'sh <(curl https://pkgx.sh) cargo' as const,
  /**
   ...
   */
  aliases: [] as const,
  fullPath: 'rust-lang.org/cargo' as const,
}
