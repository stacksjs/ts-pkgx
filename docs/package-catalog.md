...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-11-02T14:09:37.267Z
...
| **[redis.io](./packages/redis.io/index.md)** () | Redis is an in-memory database that persists on disk. The data model is key-value, but many diffe... | redis-server, redis-cli, redis-benchmark | 8.2.2 (+49) | `pkgx redis` |
