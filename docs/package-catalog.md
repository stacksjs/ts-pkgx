...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-12-10T22:11:47.451Z
...
| **[tailwindcss.com](./packages/tailwindcss.com/index.md)** () | A utility-first CSS framework for rapid UI development. | tailwindcss | 4.1.17 (+52) | `pkgx tailwindcss` |
...
| **[helm.sh](./packages/helm.sh/index.md)** () | The Kubernetes Package Manager | helm | 4.0.2 (+44) | `pkgx helm` |
...
| **[just.systems](./packages/just.systems/index.md)** () | Handy way to save and run project-specific commands | just | 1.45.0 (+50) | `pkgx just` |
...
| **[microsoft.com/code-cli](./packages/microsoft.com/code-cli/index.md)** () | Command-line interface built-in Visual Studio Code | code | 1.107.0 (+32) | `pkgx vscode cli` |
...
| Package | Description | Programs | Versions | Install |
|---------|-------------|----------|----------|----------|
| **[cli.github.com](./packages/cli.github.com/index.md)** () | GitHub’s official command line tool | gh | 2.83.2 (+92) | `pkgx gh` |
