...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-07-08T14:28:01.887Z
...
| **[elizaOS.github.io](./packages/elizaOS.github.io/index.md)** (eliza) | Autonomous agents for everyone | eliza | 1.0.20 (+21) | `pkgx eliza` |
...
| **[ollama.ai](./packages/ollama.ai/index.md)** () | Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models. | ollama | 0.9.5 (+101) | `pkgx ollama` |
| **[openai.com/openai-python](./packages/openai.com/openai-python/index.md)** () | The official Python library for the OpenAI API | openai | 1.93.1 (+243) | `pkgx openai` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1525 (+2093) | `pkgx vi` |
