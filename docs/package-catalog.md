...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-12-20T21:20:42.023Z
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.1.2001 (+2546) | `pkgx vi` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 28.4.0 (+359) | `pkgx oh-my-posh` |
