...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-07-20T23:30:33.415Z
...
| **[mise.jdx.dev](./packages/mise.jdx.dev/index.md)** () | dev tools, env vars, task runner | rtx, mise | 2025.7.17 (+305) | `pkgx mise` |
...
| **[supabase.com/cli](./packages/supabase.com/cli/index.md)** () | Supabase CLI. Manage postgres migrations, run Supabase locally, deploy edge functions. Postgres b... | supabase | 2.31.4 (+177) | `pkgx supabase` |
