...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-12-25T03:30:22.766Z
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.1.2017 (+2562) | `pkgx vi` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 28.5.1 (+361) | `pkgx oh-my-posh` |
...
| **[fly.io](./packages/fly.io/index.md)** () | Command line tools for fly.io services | fly, flyctl | 0.3.236 (+486) | `pkgx fly` |
