...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-10-22T21:11:50.917Z
...
| **[docker.com/compose](./packages/docker.com/compose/index.md)** () | Define and run multi-container applications with Docker | docker-compose | 2.40.2 (+64) | `pkgx docker-compose` |
...
| Package | Description | Programs | Versions | Install |
|---------|-------------|----------|----------|----------|
| **[cilium.io/cilium](./packages/cilium.io/cilium/index.md)** () | CLI to install, manage & troubleshoot Kubernetes clusters running Cilium | cilium | 0.18.8 (+28) | `pkgx cilium` |
...
| **[yt-dlp.org](./packages/yt-dlp.org/index.md)** () | A feature-rich command-line audio/video downloader | yt-dlp | 2025.10.22 (+58) | `pkgx yt-dlp` |
...
| **[fly.io](./packages/fly.io/index.md)** () | Command line tools for fly.io services | fly, flyctl | 0.3.201 (+452) | `pkgx fly` |
