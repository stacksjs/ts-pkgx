...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-09-22T15:32:00.206Z
...
| **[symfony.com](./packages/symfony.com/index.md)** () | The Symfony CLI tool | symfony | 5.14.0 (+51) | `pkgx symfony` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1782 (+2340) | `pkgx vi` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 26.24.0 (+327) | `pkgx oh-my-posh` |
