...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-10-22T17:10:14.734Z
...
| **[jupyter.org](./packages/jupyter.org/index.md)** () | JupyterLab computational environment. | jlpm, jupyter, jupyter-bundlerextension, ... (+21) | 4.4.10 (+56) | `pkgx jupyter` |
...
| **[mise.jdx.dev](./packages/mise.jdx.dev/index.md)** () | dev tools, env vars, task runner | rtx, mise | 2025.10.15 (+378) | `pkgx mise` |
