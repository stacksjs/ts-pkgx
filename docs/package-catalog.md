...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-07-08T19:29:06.472Z
...
| **[elizaOS.github.io](./packages/elizaOS.github.io/index.md)** (eliza) | Autonomous agents for everyone | eliza | 1.1.1 (+23) | `pkgx eliza` |
...
| **[mise.jdx.dev](./packages/mise.jdx.dev/index.md)** () | dev tools, env vars, task runner | rtx, mise | 2025.7.1 (+292) | `pkgx mise` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1525 (+2094) | `pkgx vi` |
...
| **[fly.io](./packages/fly.io/index.md)** () | Command line tools for fly.io services | fly, flyctl | 0.3.151 (+407) | `pkgx fly` |
