...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-12-11T19:11:29.637Z
...
| **[openai.com/openai-python](./packages/openai.com/openai-python/index.md)** () | The official Python library for the OpenAI API | openai | 2.11.0 (+303) | `pkgx openai` |
...
| **[terraform.io](./packages/terraform.io/index.md)** () | Terraform enables you to safely and predictably create, change, and improve infrastructure. It is... | terraform | 1.14.2 (+83) | `pkgx terraform` |
...
| **[terratag.io](./packages/terratag.io/index.md)** () | Terratag is a CLI tool that enables users of Terraform to automatically create and maintain tags ... | terratag | 0.7.5 (+20) | `pkgx terratag` |
...
| **[grafana.com/loki](./packages/grafana.com/loki/index.md)** () | Horizontally-scalable, highly-available log aggregation system | loki | 3.6.3 (+34) | `pkgx loki` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 28.2.0 (+354) | `pkgx oh-my-posh` |
