...
| **[luarocksorg](./packages/luarocksorg.md)** () | LuaRocks is the package manager for the Lua programming language. | luarocks, luarocks-admin | 3.12.0 (+4) | `pkgx luarocks` |
...
| **[ohmyposhdev](./packages/ohmyposhdev.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 26.7.0 (+288) | `pkgx oh-my-posh` |
