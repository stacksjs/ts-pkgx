...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-12-30T22:23:34.994Z
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.1.2031 (+2573) | `pkgx vi` |
...
| **[crates.io/bottom](./packages/crates.io/bottom/index.md)** () | Yet another cross-platform graphical process/system monitor. | btm | 0.12.2 (+19) | `pkgx btm` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 28.8.1 (+365) | `pkgx oh-my-posh` |
