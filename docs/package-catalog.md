...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-09-04T18:30:22.958Z
...
| **[ollama.ai](./packages/ollama.ai/index.md)** () | Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models. | ollama | 0.11.9 (+113) | `pkgx ollama` |
| **[openai.com/openai-python](./packages/openai.com/openai-python/index.md)** () | The official Python library for the OpenAI API | openai | 1.106.0 (+276) | `pkgx openai` |
...
| **[argoproj.github.io/cd](./packages/argoproj.github.io/cd/index.md)** (argocd) | GitOps Continuous Delivery for Kubernetes | argocd | 3.1.2 (+130) | `pkgx argocd` |
