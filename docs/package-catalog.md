...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-11-04T04:12:00.674Z
...
| **[openai.com/openai-python](./packages/openai.com/openai-python/index.md)** () | The official Python library for the OpenAI API | openai | 2.7.0 (+296) | `pkgx openai` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 27.4.4 (+346) | `pkgx oh-my-posh` |
