...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-09-05T19:30:22.281Z
...
| **[argoproj.github.io/cd](./packages/argoproj.github.io/cd/index.md)** (argocd) | GitOps Continuous Delivery for Kubernetes | argocd | 3.1.3 (+134) | `pkgx argocd` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1734 (+2294) | `pkgx vi` |
