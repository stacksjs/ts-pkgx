...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-12-27T23:23:35.667Z
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.1.2028 (+2571) | `pkgx vi` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 28.6.0 (+362) | `pkgx oh-my-posh` |
...
| **[filippo.io/age](./packages/filippo.io/age/index.md)** () | A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config ... | age, age-keygen | 1.3.0 (+3) | `pkgx age` |
