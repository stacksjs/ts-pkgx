...
- **Total Packages**: 533
- **Categories**: 13
- **Last Updated**: 2025-06-17T23:15:52.984Z
...
| **[pnpmio](./packages/pnpmio.md)** () | Fast, disk space efficient package manager | pnpm, pnpx | 10.12.1 (+164) | `pkgx pnp` |
| **[pythonpoetryorg](./packages/pythonpoetryorg.md)** () | Python packaging and dependency management made easy | poetry | 2.1.3 (+20) | `pkgx poetry` |
...
| **[surrealdbcom](./packages/surrealdbcom.md)** () | A scalable, distributed, collaborative, document-graph database, for the realtime web | surreal | 2023.9.1 (+43) | `pkgx surreal` |
...
| Package | Description | Programs | Versions | Install |
|---------|-------------|----------|----------|----------|
| **[curlse](./packages/curlse.md)** () | A command line tool and library for transferring data with URL syntax, supporting DICT, FILE, FTP... | curl, curl-config | 8.14.1 (+24) | `pkgx cURL` |
...
| **[helixeditorcom](./packages/helixeditorcom.md)** () | A post-modern modal text editor. | hx | 25.1.1 (+7) | `pkgx hx` |
...
| **[libziporg](./packages/libziporg.md)** () | A C library for reading, creating, and modifying zip archives. | zipcmp, zipmerge, ziptool | 1.11.4 (+6) | `pkgx zip` |
...
| **[localaiio](./packages/localaiio.md)** (local-ai) | :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-fir... | local-ai | 2.26.0 (+36) | `pkgx LocalAI` |
...
| **[openexrcom](./packages/openexrcom.md)** () | The OpenEXR project provides the specification and reference implementation of the EXR file forma... | exr2aces, exrenvmap, exrheader, ... (+5) | 3.3.4 (+19) | `pkgx exr` |
...
| **[openjpegorg](./packages/openjpegorg.md)** () | Official repository of the OpenJPEG project | opj_compress, opj_decompress, opj_dump | 2.5.3 (+3) | `pkgx opj` |
...
| **[riotermcom](./packages/riotermcom.md)** () | A hardware-accelerated GPU terminal emulator focusing to run in desktops and browsers. | rio | 0.2.19 (+3) | `pkgx rio` |
