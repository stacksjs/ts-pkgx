...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-07-31T04:00:07.812Z
...
| **[ollama.ai](./packages/ollama.ai/index.md)** () | Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models. | ollama | 0.10.0 (+103) | `pkgx ollama` |
