...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-09-02T15:31:05.562Z
...
| **[openai.com/openai-python](./packages/openai.com/openai-python/index.md)** () | The official Python library for the OpenAI API | openai | 1.103.0 (+271) | `pkgx openai` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1725 (+2286) | `pkgx vi` |
