...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-08-22T19:28:40.874Z
...
| **[terragrunt.gruntwork.io](./packages/terragrunt.gruntwork.io/index.md)** () | Terragrunt is a flexible orchestration tool that allows Infrastructure as Code written in OpenTof... | terragrunt | 0.86.0 (+367) | `pkgx terragrunt` |
...
| **[mise.jdx.dev](./packages/mise.jdx.dev/index.md)** () | dev tools, env vars, task runner | rtx, mise | 2025.8.18 (+336) | `pkgx mise` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1665 (+2229) | `pkgx vi` |
...
| **[caddyserver.com](./packages/caddyserver.com/index.md)** () | Fast and extensible multi-platform HTTP/1-2-3 web server with automatic HTTPS | caddy | 2.10.1 (+10) | `pkgx caddy` |
