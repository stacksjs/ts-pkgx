...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-08-07T22:31:02.112Z
...
| **[elizaOS.github.io](./packages/elizaOS.github.io/index.md)** (eliza) | Autonomous agents for everyone | eliza | 1.3.2 (+44) | `pkgx eliza` |
...
| **[ollama.ai](./packages/ollama.ai/index.md)** () | Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models. | ollama | 0.11.3 (+107) | `pkgx ollama` |
| **[openai.com/openai-python](./packages/openai.com/openai-python/index.md)** () | The official Python library for the OpenAI API | openai | 1.99.2 (+257) | `pkgx openai` |
...
| **[postgrest.org](./packages/postgrest.org/index.md)** () | Serves a fully RESTful API from any existing PostgreSQL database | postgrest | <Error><Code>InternalError</Code><Message>We encountered an internal error. Please try again.</Message><RequestId>Y9QWZTVSWZGR6S22</RequestId><HostId>kRqGZ0DHOoSjCFVllzZWASv4+n8M03tJ/rUDqcLk75EuTInjYgD80bFNqv07x5J9EDacXaQ1zyk=</HostId></Error> (+1) | `pkgx postgrest` |
...
| **[helm.sh](./packages/helm.sh/index.md)** () | The Kubernetes Package Manager | helm | 3.18.4 (+35) | `pkgx helm` |
| **[istio.io](./packages/istio.io/index.md)** () | Connect, secure, control, and observe services. | istioctl | 1.26.3 (+42) | `pkgx istioctl` |
...
| Package | Description | Programs | Versions | Install |
|---------|-------------|----------|----------|----------|
| **[bun.sh](./packages/bun.sh/index.md)** (bun.com) | Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one | bun, bunx | 1.2.19 (+122) | `pkgx bun.com` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1602 (+2170) | `pkgx vi` |
...
| **[checkov.io](./packages/checkov.io/index.md)** () | Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as c... | checkov | 3.2.458 (+490) | `pkgx checkov` |
