...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-09-27T12:31:29.999Z
...
| **[k9scli.io](./packages/k9scli.io/index.md)** () | 🐶 Kubernetes CLI To Manage Your Clusters In Style! | k9s | 0.50.12 (+57) | `pkgx k9s` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1797 (+2354) | `pkgx vi` |
