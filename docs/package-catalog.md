...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-10-28T09:11:02.386Z
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.1.1882 (+2432) | `pkgx vi` |
...
| **[traefik.io](./packages/traefik.io/index.md)** () | The Cloud Native Application Proxy | traefik | 3.5.3 (+70) | `pkgx traefik` |
...
| **[fly.io](./packages/fly.io/index.md)** () | Command line tools for fly.io services | fly, flyctl | 0.3.203 (+454) | `pkgx fly` |
...
| **[supabase.com/cli](./packages/supabase.com/cli/index.md)** () | Supabase CLI. Manage postgres migrations, run Supabase locally, deploy edge functions. Postgres b... | supabase | 2.54.10 (+194) | `pkgx supabase` |
