...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-11-01T03:28:50.379Z
...
| **[ollama.ai](./packages/ollama.ai/index.md)** () | Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models. | ollama | 0.12.8 (+123) | `pkgx ollama` |
...
| **[mise.jdx.dev](./packages/mise.jdx.dev/index.md)** () | dev tools, env vars, task runner | rtx, mise | 2025.11.0 (+385) | `pkgx mise` |
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.1.1891 (+2441) | `pkgx vi` |
