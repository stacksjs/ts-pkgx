...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-11-06T03:32:01.984Z
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 27.5.1 (+348) | `pkgx oh-my-posh` |
...
| **[fly.io](./packages/fly.io/index.md)** () | Command line tools for fly.io services | fly, flyctl | 0.3.208 (+459) | `pkgx fly` |
