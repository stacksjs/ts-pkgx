...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-07-29T13:43:12.092Z
...
| **[supabase.com/cli](./packages/supabase.com/cli/index.md)** () | Supabase CLI. Manage postgres migrations, run Supabase locally, deploy edge functions. Postgres b... | supabase | 2.33.4 (+181) | `pkgx supabase` |
