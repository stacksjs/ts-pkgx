...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-12-17T05:12:13.185Z
...
| **[kubernetes.io/kubectl](./packages/kubernetes.io/kubectl/index.md)** () | Production-Grade Container Scheduling and Management | kubectl | 1.34.3 (+126) | `pkgx kubectl` |
...
| **[mise.jdx.dev](./packages/mise.jdx.dev/index.md)** () | dev tools, env vars, task runner | rtx, mise | 2025.12.10 (+407) | `pkgx mise` |
