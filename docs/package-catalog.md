...
- **Total Packages**: 1396
- **Categories**: 27
- **Last Updated**: 2025-09-11T14:31:30.318Z
...
| **[mise.jdx.dev](./packages/mise.jdx.dev/index.md)** () | dev tools, env vars, task runner | rtx, mise | 2025.9.8 (+346) | `pkgx mise` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 26.23.1 (+318) | `pkgx oh-my-posh` |
...
| **[railway.app](./packages/railway.app/index.md)** () | Develop and deploy code with zero configuration | railway | 4.7.3 (+57) | `pkgx railway` |
