...
- **Total Packages**: 1396
- **Categories**: 27
- **Last Updated**: 2025-10-09T23:29:56.892Z
...
| **[pnpm.io](./packages/pnpm.io/index.md)** () | Fast, disk space efficient package manager | pnpm, pnpx | 10.18.2 (+179) | `pkgx pnpm` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1843 (+2399) | `pkgx vi` |
