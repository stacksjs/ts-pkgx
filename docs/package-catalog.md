...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-12-01T20:10:29.163Z
...
| **[dart.dev](./packages/dart.dev/index.md)** () | The Dart SDK, including the VM, JS and Wasm compilers, analysis, core libraries, and more. | dart, dartaotruntime | 3.10.2 (+45) | `pkgx dart` |
...
| **[ansible.com/ansible-lint](./packages/ansible.com/ansible-lint/index.md)** () | ansible-lint checks playbooks for practices and behavior that could potentially be improved and c... | ansible-lint | 25.11.1 (+31) | `pkgx ansible-lint` |
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.1.1943 (+2492) | `pkgx vi` |
...
| Package | Description | Programs | Versions | Install |
|---------|-------------|----------|----------|----------|
| **[aws.amazon.com/sam](./packages/aws.amazon.com/sam/index.md)** () | CLI tool to build, test, debug, and deploy Serverless applications using AWS SAM | sam | 1.149.0 (+41) | `pkgx sam` |
| **[fly.io](./packages/fly.io/index.md)** () | Command line tools for fly.io services | fly, flyctl | 0.3.227 (+477) | `pkgx fly` |
...
| **[planetscale.com](./packages/planetscale.com/index.md)** () | The CLI for PlanetScale Database | pscale | 0.263.0 (+85) | `pkgx pscale` |
...
| **[supabase.com/cli](./packages/supabase.com/cli/index.md)** () | Supabase CLI. Manage postgres migrations, run Supabase locally, deploy edge functions. Postgres b... | supabase | 2.62.10 (+199) | `pkgx supabase` |
