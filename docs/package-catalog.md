...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-09-26T15:31:02.624Z
...
| **[mesonbuild.com](./packages/mesonbuild.com/index.md)** () | Fast and user friendly build system | meson | 1.9.1 (+31) | `pkgx meson` |
...
| **[mise.jdx.dev](./packages/mise.jdx.dev/index.md)** () | dev tools, env vars, task runner | rtx, mise | 2025.9.19 (+356) | `pkgx mise` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1792 (+2350) | `pkgx vi` |
...
| **[railway.app](./packages/railway.app/index.md)** () | Develop and deploy code with zero configuration | railway | 4.9.0 (+59) | `pkgx railway` |
