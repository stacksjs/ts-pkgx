...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-07-07T07:30:13.288Z
...
| **[elizaOS.github.io](./packages/elizaOS.github.io/index.md)** (eliza) | Autonomous agents for everyone | eliza | 1.0.18 (+19) | `pkgx eliza` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 26.14.1 (+296) | `pkgx oh-my-posh` |
