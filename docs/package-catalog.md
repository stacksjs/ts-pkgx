...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2025-12-18T17:12:52.552Z
...
| **[taskfile.dev](./packages/taskfile.dev/index.md)** () | A task runner / simpler Make alternative written in Go | task | 3.46.1 (+35) | `pkgx task` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 28.3.1 (+358) | `pkgx oh-my-posh` |
