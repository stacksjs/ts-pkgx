...
- **Total Packages**: 531
- **Categories**: 13
- **Last Updated**: 2025-06-10T05:56:47.827Z
...
| **[cnqueryio](./packages/cnqueryio.md)** () | open source, cloud-native, graph-based asset inventory | cnquery | 11.57.2 (+145) | `pkgx cnquery` |
...
| **[conftestdev](./packages/conftestdev.md)** () | Write tests against structured configuration data using the Open Policy Agent Rego query language | conftest | 0.61.1 (+17) | `pkgx conftest` |
...
| **[openmpllvmorg](./packages/openmpllvmorg.md)** () | The LLVM Project is a collection of modular and reusable compiler and toolchain technologies. | - | 20.1.6 (+31) | `pkgx libomp` |
