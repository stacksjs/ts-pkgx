...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-09-19T11:29:56.931Z
...
| **[openai.com/openai-python](./packages/openai.com/openai-python/index.md)** () | The official Python library for the OpenAI API | openai | 1.108.0 (+282) | `pkgx openai` |
...
| **[symfony.com](./packages/symfony.com/index.md)** () | The Symfony CLI tool | symfony | 5.13.0 (+50) | `pkgx symfony` |
...
| **[vitejs.dev](./packages/vitejs.dev/index.md)** () | Next generation frontend tooling. It&#39;s fast! | vite | 7.1.6 (+116) | `pkgx vite` |
...
| **[argoproj.github.io/cd](./packages/argoproj.github.io/cd/index.md)** (argocd) | GitOps Continuous Delivery for Kubernetes | argocd | 3.1.6 (+144) | `pkgx argocd` |
...
| **[k9scli.io](./packages/k9scli.io/index.md)** () | 🐶 Kubernetes CLI To Manage Your Clusters In Style! | k9s | 0.50.11 (+56) | `pkgx k9s` |
...
| **[vim.org](./packages/vim.org/index.md)** (vim, vi) | The official Vim repository | vim, vi | 9.1.1775 (+2333) | `pkgx vi` |
...
| **[ohmyposh.dev](./packages/ohmyposh.dev/index.md)** () | The most customisable and low-latency cross platform/shell prompt renderer | oh-my-posh | 26.23.8 (+325) | `pkgx oh-my-posh` |
...
| **[cloudflare.com/cloudflared](./packages/cloudflare.com/cloudflared/index.md)** () | Cloudflare Tunnel client (formerly Argo Tunnel) | cloudflared | 2025.9.0 (+31) | `pkgx cloudflared` |
| **[curl.se](./packages/curl.se/index.md)** (curl) | A command line tool and library for transferring data with URL syntax, supporting DICT, FILE, FTP... | curl, curl-config | 8.16.0 (+26) | `pkgx curl` |
| **[gnu.org/wget](./packages/gnu.org/wget/index.md)** () | Internet file retriever | wget | 1.25.0 (+3) | `pkgx wget` |
...
| **[planetscale.com](./packages/planetscale.com/index.md)** () | The CLI for PlanetScale Database | pscale | 0.257.0 (+79) | `pkgx pscale` |
