...
- **Total Packages**: 866
- **Categories**: 13
- **Last Updated**: 2025-05-26T03:52:19.858Z
...
- [Other Utilities](#other-utilities) (779 packages)
...
| **[python](./packages/python.md)** (python) | The Python programming language | python, python&lbrace;&lbrace; version.major &rbrace;&rbrace;, python&lbrace;&lbrace; version.marketing &rbrace;&rbrace; | 3.13.3 (+144) | `pkgx python` |
...
| **[yarnpkgcom](./packages/yarnpkgcom.md)** () | 📦🐈 Active development trunk for Yarn ⚒ | yarn, yarnpkg | 4.9.1 (+38) | `pkgx yarn` |
...
| **[gradleorg](./packages/gradleorg.md)** () | Open-source build automation tool based on the Groovy and Kotlin DSL | gradle | 8.14.1 (+15) | `pkgx gradle` |
...
| Package | Description | Programs | Versions | Install |
|---------|-------------|----------|----------|----------|
| **[pytestorg](./packages/pytestorg.md)** () | The pytest framework makes it easy to write small tests, yet scales to support complex functional... | pytest | 8.3.5 (+24) | `pkgx pytest` |

## Other Utilities

*779 packages in this category*
...
| **[appiumio](./packages/appiumio.md)** () | Cross-platform automation framework for all kinds of apps, built on top of the W3C WebDriver prot... | appium | 2.18.0 (+35) | `pkgx appium` |
...
| **[arkadedev](./packages/arkadedev.md)** () | Open Source Marketplace For Developer Tools | arkade | 0.11.39 (+36) | `pkgx Arkade` |
...
| **[awsamazoncomcli](./packages/awsamazoncomcli.md)** (aws/cli, cli) | Universal Command Line Interface for Amazon Web Services | aws | 2.27.21 (+892) | `pkgx aws/cli` |
...
| **[bytebasecom](./packages/bytebasecom.md)** () | World's most advanced database DevSecOps solution for Developer, Security, DBA and Platform Engin... | bytebase | 3.6.2 (+29) | `pkgx bytebase` |
...
| **[cnqueryio](./packages/cnqueryio.md)** () | open source, cloud-native, graph-based asset inventory | cnquery | 11.55.0 (+141) | `pkgx cnquery` |
...
| **[codercom](./packages/codercom.md)** () | Tool for provisioning self-hosted development environments with Terraform | coder | 2.22.1 (+66) | `pkgx coder` |
...
| **[ctagsio](./packages/ctagsio.md)** () | A maintained ctags implementation | ctags | 6.1.0 (+0) | `pkgx ctags` |
...
| **[fastlanetools](./packages/fastlanetools.md)** () | 🚀 The easiest way to automate building and releasing your iOS and Android apps | fastlane | 2.227.2 (+21) | `pkgx fastlane` |
...
| **[giflibsourceforgeio](./packages/giflibsourceforgeio.md)** () | Library and utilities for processing GIFs | gif2rgb, gifbuild, gifclrmp, ... (+3) | 5.2.2 (+1) | `pkgx gif` |
| **[gitclifforg](./packages/gitclifforg.md)** () | A highly customizable Changelog Generator that follows Conventional Commit specifications ⛰️ | git-cliff | 2.8.0 (+20) | `pkgx git-cliff` |
...
| **[gitleaksio](./packages/gitleaksio.md)** () | Find secrets with Gitleaks 🔑 | gitleaks | 8.26.0 (+25) | `pkgx gitleaks` |
...
| **[gohugoio](./packages/gohugoio.md)** (hugo) | The world’s fastest framework for building websites. | hugo | 0.147.5 (+119) | `pkgx hugo` |
...
| **[goreleasercom](./packages/goreleasercom.md)** () | Deliver Go binaries as fast and easily as possible | goreleaser | 2.9.0 (+37) | `pkgx goreleaser` |
...
| **[gqlgencom](./packages/gqlgencom.md)** () | go generate based graphql server library | gqlgen | 0.17.73 (+36) | `pkgx gqlgen` |
...
| **[jbangdev](./packages/jbangdev.md)** () | Unleash the power of Java - JBang Lets Students, Educators and Professional Developers create, ed... | jbang | 0.126.1 (+19) | `pkgx jbang` |
...
| **[kubesharkco](./packages/kubesharkco.md)** () | The API traffic analyzer for Kubernetes providing real-time K8s protocol-level visibility, captur... | kubeshark | 72.3.83 (+53) | `pkgx kubeshark` |
...
| **[luaorg](./packages/luaorg.md)** () | Powerful, lightweight programming language | lua, luac | 5.4.7 (+2) | `pkgx lua` |
| **[luarocksorg](./packages/luarocksorg.md)** () | LuaRocks is the package manager for the Lua programming language. | luarocks, luarocks-admin | 3.11.1 (+3) | `pkgx luarocks` |
...
| **[mailpitaxllentorg](./packages/mailpitaxllentorg.md)** () | An email and SMTP testing tool with API for developers | mailpit | 1.25.1 (+64) | `pkgx mailpit` |
...
| **[matiosourceforgeio](./packages/matiosourceforgeio.md)** (libmatio) | C library for reading and writing MATLAB MAT files | matdump | 1.5.28 (+5) | `pkgx libmatio` |
| **[maturinrs](./packages/maturinrs.md)** () | Build and publish crates with pyo3, cffi and uniffi bindings as well as rust binaries as python p... | maturin | 1.8.6 (+18) | `pkgx maturin` |
...
| **[mpg123de](./packages/mpg123de.md)** () | MP3 player for Linux and UNIX | mpg123 | 1.32.10 (+11) | `pkgx mpg123` |
...
| **[munlangorg](./packages/munlangorg.md)** () | Source code for the Mun language and runtime. | mun | 0.5.0 (+0) | `pkgx mun` |
...
| **[openinterpretercom](./packages/openinterpretercom.md)** (open-interpreter) | A natural language interface for computers | interpreter | 0.4.0 (+21) | `pkgx open-interpreter` |
...
| **[pocketbaseio](./packages/pocketbaseio.md)** () | Open source backend for your next project in 1 file | pocketbase | 0.28.2 (+79) | `pkgx pocketbase` |
...
| **[postgrestorg](./packages/postgrestorg.md)** () | Serves a fully RESTful API from any existing PostgreSQL database | postgrest | 13.0.0 (+10) | `pkgx postgrest` |
...
| **[singboxapp](./packages/singboxapp.md)** () | The universal proxy platform | sing-box | 1.11.11 (+48) | `pkgx sing-box` |
...
| **[steampipeio](./packages/steampipeio.md)** () | Zero-ETL, infinite possibilities. Live query APIs, code & more with SQL. No DB required. | steampipe | 1.1.3 (+31) | `pkgx steampipe` |
...
| **[streamlinkgithubio](./packages/streamlinkgithubio.md)** () | Streamlink is a CLI utility which pipes video streams from various services into a video player | streamlink | 7.3.0 (+18) | `pkgx streamlink` |
...
| **[tectonictypesettinggithubio](./packages/tectonictypesettinggithubio.md)** () | A modernized, complete, self-contained TeX/LaTeX engine, powered by XeTeX and TeXLive. | tectonic | 0.15.0 (+5) | `pkgx tectonic` |
...
| **[tursotech](./packages/tursotech.md)** () | Command line interface to Turso. | turso | 1.0.10 (+88) | `pkgx turso` |
...
| **[valesh](./packages/valesh.md)** () | :pencil: A markup-aware linter for prose built with speed and extensibility in mind. | vale | 3.11.2 (+43) | `pkgx vale` |
...
| **[xpraorg](./packages/xpraorg.md)** () | Persistent remote applications for X11; screen sharing for X11, MacOS and MSWindows. | xpra | 6.3.0 (+8) | `pkgx xpra` |
| **[xtlsgithubio](./packages/xtlsgithubio.md)** (xray-core) | Xray, Penetrates Everything. Also the best v2ray-core, with XTLS support. Fully compatible config... | xray | 25.5.16 (+29) | `pkgx xray-core` |
