...
- **Total Packages**: 1399
- **Categories**: 27
- **Last Updated**: 2026-01-13T21:15:44.107Z
...
| **[php.net](./packages/php.net/index.md)** () | General-purpose scripting language | pear, pecl, phar, ... (+5) | 8.5.1 (+92) | `pkgx php` |
...
| **[vim.org](./packages/vim.org/index.md)** (vi) | The official Vim repository | vim, vi | 9.1.2082 (+2621) | `pkgx vi` |
