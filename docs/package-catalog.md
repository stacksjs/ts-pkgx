...
- **Total Packages**: 1397
- **Categories**: 27
- **Last Updated**: 2025-08-28T20:30:30.688Z
...
| **[nodejs.org](./packages/nodejs.org/index.md)** () | Platform built on V8 to build network applications | node | 24.7.0 (+148) | `pkgx node` |
...
| **[elizaOS.github.io](./packages/elizaOS.github.io/index.md)** (eliza) | Autonomous agents for everyone | eliza | 1.4.5 (+52) | `pkgx eliza` |
...
| **[ollama.ai](./packages/ollama.ai/index.md)** () | Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models. | ollama | 0.11.7 (+111) | `pkgx ollama` |
...
| **[planetscale.com](./packages/planetscale.com/index.md)** () | The CLI for PlanetScale Database | pscale | 0.253.0 (+75) | `pkgx pscale` |
...
| **[getfoundry.sh](./packages/getfoundry.sh/index.md)** () | Foundry is a blazing fast, portable and modular toolkit for Ethereum application development writ... | forge, anvil, cast, ... (+1) | 2024.4.12 (+11) | `pkgx getfoundry.sh` |
