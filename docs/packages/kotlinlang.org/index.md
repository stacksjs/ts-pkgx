...
- `2.2.21`, `2.2.20`, `2.2.10`, `2.2.0`, `2.1.21`
- `2.1.20`, `2.1.10`, `2.1.0`, `2.0.21`, `2.0.20`
- `2.0.10`, `2.0.0`, `1.9.25`, `1.9.24`, `1.9.23`
- `1.9.22`, `1.9.21`, `1.9.20`, `1.9.10`, `1.9.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +kotlinlang.org@2.2.21 -- $SHELL -i
```
