...
- `0.135.0`, `0.134.3`, `0.134.2`, `0.132.1`, `0.132.0`
- `0.131.0`, `0.130.0`, `0.129.0`, `0.128.7`, `0.128.6`
- `0.128.5`, `0.128.2`, `0.128.1`, `0.128.0`, `0.127.18`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +jbang.dev@0.135.0 -- $SHELL -i
```
