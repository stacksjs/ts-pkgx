...
```bash
# Install with pkgx
sh <(curl https://pkgx.sh) +gnome.org/glib -- $SHELL -i
```
...
- [`gnome.org/gsettings-desktop-schemas`](gnomeorggsettingsdesktopschemas.md) - A package from gnome.org/gsettings-desktop-schemas
