...
- `29.1.3`, `29.1.2`, `29.1.1`, `29.1.0`, `29.0.4`
- `29.0.3`, `29.0.2`, `29.0.1`, `28.5.2`, `28.5.1`
- `28.5.0`, `28.4.0`, `28.3.3`, `28.3.2`, `28.3.1`
...
**Latest Version**: `29.1.3`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +docker.com/cli@29.1.3 -- $SHELL -i
```
