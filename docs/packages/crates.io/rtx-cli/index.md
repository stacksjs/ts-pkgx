...
<details>
<summary>Show all 395 versions</summary>

- `2025.7.16`, `2025.7.12`, `2025.7.11`, `2025.7.10`, `2025.7.9`
...
**Latest Version**: `2025.7.16`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +crates.io/rtx-cli@2025.7.16 -- $SHELL -i
```
