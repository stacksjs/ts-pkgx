...
- `16.26.0`, `16.25.1`, `16.25.0`, `16.24.1`, `16.24.0`
- `16.23.1`, `16.23.0`, `16.22.0`, `16.21.0`, `16.20.4`
...
**Latest Version**: `16.26.0`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +expo.dev/eas-cli@16.26.0 -- $SHELL -i
```
