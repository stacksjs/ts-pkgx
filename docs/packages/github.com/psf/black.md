...
- `25.12.0`, `25.11.0`, `25.9.0`, `25.1.0`, `24.10.0`
- `24.8.0`, `24.4.2`, `24.4.1`, `24.4.0`, `24.3.0`
- `24.2.0`, `24.1.1`, `24.1.0`, `23.12.1`, `23.12.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/psf/black@25.12.0 -- $SHELL -i
```
