...
- `0.3.90`, `0.3.89`, `0.3.88`, `0.3.87`, `0.3.86`
- `0.3.85`, `0.3.84`, `0.3.83`, `0.3.82`, `0.3.81`
- `0.3.80`, `0.3.79`, `0.3.78`, `0.3.77`, `0.3.76`
...
**Latest Version**: `0.3.90`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/jameswoolfenden/pike@0.3.90 -- $SHELL -i
```
