...
- `1.4.339`, `1.4.338`, `1.4.337`, `1.4.336`, `1.4.335`
- `1.4.334`, `1.4.333`, `1.4.332`, `1.4.331`, `1.4.330`
...
**Latest Version**: `1.4.339`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/KhronosGroup/Vulkan-Headers@1.4.339 -- $SHELL -i
```
