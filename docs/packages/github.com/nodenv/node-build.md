...
- `5.4.20`, `5.4.19`, `5.4.18`, `5.4.17`, `5.4.16`
- `5.4.15`, `5.4.14`, `5.4.13`, `5.4.12`, `5.4.11`
...
**Latest Version**: `5.4.20`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/nodenv/node-build@5.4.20 -- $SHELL -i
```
