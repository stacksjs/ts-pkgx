...
- `5.4.23`, `5.4.22`, `5.4.21`, `5.4.20`, `5.4.19`
- `5.4.18`, `5.4.17`, `5.4.16`, `5.4.15`, `5.4.14`
...
**Latest Version**: `5.4.23`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/nodenv/node-build@5.4.23 -- $SHELL -i
```
