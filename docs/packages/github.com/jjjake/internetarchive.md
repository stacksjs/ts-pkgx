...
- `5.7.0`, `5.6.1`, `5.6.0`, `5.5.1`, `5.5.0`
- `5.4.1`, `5.4.0`, `5.3.0`, `5.2.1`, `5.1.0`
- `5.0.5`, `5.0.3`, `5.0.0`, `4.1.0`, `4.0.1`
- `3.7.0`, `3.4.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/jjjake/internetarchive@5.7.0 -- $SHELL -i
```
