...
- `1.43.2`, `1.43.1`, `1.43.0`, `1.42.1`, `1.42.0`
- `1.41.0`, `1.40.4`, `1.40.3`, `1.40.2`, `1.40.1`
- `1.40.0`, `1.39.1`, `1.39.0`, `1.38.3`, `1.38.2`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/aws-cloudformation/cfn-lint@1.43.2 -- $SHELL -i
```
