...
- `1.0.1`, `1.0.0`, `0.30.35`, `0.30.34`, `0.30.33`
- `0.30.32`, `0.30.31`, `0.30.30`, `0.30.29`, `0.30.28`
- `0.30.27`, `0.30.26`, `0.30.25`, `0.30.24`, `0.30.23`
- `0.30.22`, `0.30.21`, `0.30.20`, `0.30.18`, `0.30.17`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/chainguard-dev/apko@1.0.1 -- $SHELL -i
```
