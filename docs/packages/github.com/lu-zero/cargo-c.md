...
- `0.10.1`, `0.10.0`, `0.9.32`, `0.9.31`, `0.9.30`
- `0.9.29`, `0.9.28`, `0.9.27`, `0.9.26`, `0.9.24`
- `0.9.22`, `0.9.21`, `0.9.20`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/lu-zero/cargo-c@0.10.16 -- $SHELL -i
```
