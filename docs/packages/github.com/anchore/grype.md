...
- `0.105.0`, `0.104.4`, `0.104.3`, `0.104.2`, `0.104.1`
- `0.104.0`, `0.103.0`, `0.102.0`, `0.101.1`, `0.101.0`
- `0.100.0`, `0.99.1`, `0.99.0`, `0.98.0`, `0.97.2`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +github.com/anchore/grype@0.105.0 -- $SHELL -i
```
