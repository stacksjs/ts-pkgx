...
- `21.1.7`, `21.1.6`, `21.1.5`, `21.1.4`, `21.1.3`
- `21.1.2`, `21.1.1`, `21.1.0`, `20.1.8`, `20.1.7`
- `20.1.6`, `20.1.5`, `20.1.4`, `20.1.3`, `20.1.2`
- `20.1.1`, `20.1.0`, `19.1.7`, `19.1.6`, `19.1.4`
...
**Latest Version**: `21.1.7`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +llvm.org@21.1.7 -- $SHELL -i
```
