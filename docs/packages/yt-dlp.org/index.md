...
- `2025.11.12`, `2025.10.22`, `2025.10.14`, `2025.9.26`, `2025.9.23`
- `2025.9.5`, `2025.8.27`, `2025.8.22`, `2025.8.20`, `2025.8.11`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +yt-dlp.org@2025.11.12 -- $SHELL -i
```
