...
- `38.4.0`, `38.3.0`, `38.2.0`, `38.1.0`, `38.0.0`
- `37.7.1`, `37.7.0`, `37.6.0`, `37.5.0`, `37.4.0`
- `37.3.0`, `37.2.0`, `37.1.0`, `37.0.0`, `36.5.0`
- `36.4.0`, `36.3.0`, `36.2.0`, `36.1.0`, `35.8.1`
...
**Latest Version**: `38.4.0`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +rucio.cern.ch/rucio-client@38.4.0 -- $SHELL -i
```
