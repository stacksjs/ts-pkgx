...
- `25.12.1`, `25.12.0`, `25.11.1`, `25.11.0`, `25.9.2`
- `25.9.1`, `25.9.0`, `25.8.2`, `25.8.1`, `25.8.0`
...
**Latest Version**: `25.12.1`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +ansible.com/ansible-lint@25.12.1 -- $SHELL -i
```
