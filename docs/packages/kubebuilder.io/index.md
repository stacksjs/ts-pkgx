...
- `4.10.1`, `4.10.0`, `4.9.0`, `4.8.0`, `4.7.1`
- `4.7.0`, `4.6.0`, `4.5.2`, `4.5.1`, `4.5.0`
- `4.4.0`, `4.3.1`, `4.3.0`, `4.2.0`, `4.1.1`
- `4.1.0`, `4.0.0`, `3.15.1`, `3.15.0`, `3.14.2`
- `3.14.1`, `3.14.0`, `3.13.0`, `3.12.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +kubebuilder.io@4.10.1 -- $SHELL -i
```
