...
- **Domain**: `z.sh/syntax-highlighting`
...
launchpad install z.sh/syntax-highlighting
```
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +z.sh/syntax-highlighting@0.8.0 -- $SHELL -i
```
...
// Access this package
const pkg = pantry.zshsyntaxhighlighting
