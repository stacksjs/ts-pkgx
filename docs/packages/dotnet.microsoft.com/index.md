...
- `9.0.308`, `9.0.306`, `9.0.303`, `9.0.202`, `9.0.111`
- `9.0.102`, `9.0.100`, `8.0.415`, `8.0.410`, `8.0.405`
- `8.0.403`, `8.0.402`, `8.0.401`, `8.0.318`, `8.0.313`
- `8.0.308`, `8.0.303`, `8.0.302`, `8.0.301`, `8.0.206`
- `8.0.204`, `8.0.203`, `8.0.121`, `8.0.112`, `8.0.107`
- `8.0.106`, `8.0.104`, `8.0.101`, `8.0.100`, `7.0.404`
- `7.0.306`, `7.0.120`, `6.0.424`, `6.0.423`, `6.0.422`
- `6.0.417`, `6.0.132`, `6.0.131`, `6.0.130`

</details>

**Latest Version**: `9.0.308`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +dotnet.microsoft.com@9.0.308 -- $SHELL -i
```
