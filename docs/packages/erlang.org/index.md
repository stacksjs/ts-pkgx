...
- `28.0.2`, `28.0.1`, `28.0.0`, `27.3.4.6`, `27.3.4.5`
- `27.3.4.4`, `27.3.4.3`, `27.3.4.2`, `27.3.4.1`, `27.3.4`
...
- `26.2.5.4`, `26.2.5.3`, `26.2.5.2`, `26.2.5.16`, `26.2.5.15`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +erlang.org@28.2.0 -- $SHELL -i
```
