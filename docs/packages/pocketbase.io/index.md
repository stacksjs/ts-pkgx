...
- `0.34.0`, `0.33.0`, `0.32.0`, `0.31.0`, `0.30.4`
...
- `0.23.3`, `0.23.2`, `0.23.1`, `0.23.0`, `0.22.37`
- `0.22.36`, `0.22.35`, `0.22.34`, `0.22.33`, `0.22.32`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +pocketbase.io@0.36.0 -- $SHELL -i
```
