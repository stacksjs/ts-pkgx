...
- `0.6.138`, `0.6.137`, `0.6.136.1`, `0.6.136`, `0.6.135`
- `0.6.134`, `0.6.133`, `0.6.132`, `0.6.131`, `0.6.130`
- `0.6.129`, `0.6.128`, `0.6.127`, `0.6.126`, `0.6.125`
- `0.6.124`, `0.6.123`, `0.6.122`, `0.6.121`, `0.6.120`
- `0.6.119`, `0.6.118`, `0.6.117`, `0.6.116`, `0.6.115`
...
**Latest Version**: `0.6.138`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +digger.dev@0.6.138 -- $SHELL -i
```
