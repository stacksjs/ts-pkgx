...
- `4.108.0`, `4.107.1`, `4.107.0`, `4.106.3`, `4.106.2`
- `4.106.0`, `4.105.1`, `4.105.0`, `4.104.3`, `4.104.2`
- `4.104.1`, `4.104.0`, `4.103.2`, `4.103.1`, `4.103.0`
...
**Latest Version**: `4.108.0`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +coder.com/code-server@4.108.0 -- $SHELL -i
```
