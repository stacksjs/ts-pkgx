...
<details>
<summary>Show all 1106 versions</summary>
...
- `2.10.3`, `1.42.64`, `1.42.63`, `1.42.62`, `1.42.61`
...
**Latest Version**: `2.31.28`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.28 -- $SHELL -i
```
