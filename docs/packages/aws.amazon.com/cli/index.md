...
<details>
<summary>Show all 1177 versions</summary>
...
- `2.10.3`, `1.44.7`, `1.44.6`, `1.44.5`, `1.44.4`
...
**Latest Version**: `2.32.24`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.32.24 -- $SHELL -i
```
