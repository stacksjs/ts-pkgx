...
<details>
<summary>Show all 1157 versions</summary>
...
- `2.10.3`, `1.43.13`, `1.43.12`, `1.43.11`, `1.43.10`
...
**Latest Version**: `2.32.14`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.32.14 -- $SHELL -i
```
