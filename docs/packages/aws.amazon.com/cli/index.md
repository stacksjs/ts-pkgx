...
<details>
<summary>Show all 1121 versions</summary>
...
- `2.11.7`, `2.10.4`, `2.10.3`, `1.42.72`, `1.42.71`
...
**Latest Version**: `2.31.35`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.35 -- $SHELL -i
```
