...
<details>
<summary>Show all 1151 versions</summary>
...
- `2.11.7`, `2.10.4`, `2.10.3`, `1.43.10`, `1.43.9`
...
**Latest Version**: `2.32.11`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.32.11 -- $SHELL -i
```
