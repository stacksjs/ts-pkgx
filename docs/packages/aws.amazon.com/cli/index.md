...
<details>
<summary>Show all 1167 versions</summary>
...
- `2.10.3`, `1.44.2`, `1.44.1`, `1.44.0`, `1.43.15`
...
**Latest Version**: `2.32.19`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.32.19 -- $SHELL -i
```
