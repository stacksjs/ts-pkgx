...
<details>
<summary>Show all 1117 versions</summary>
...
- `2.10.3`, `1.42.70`, `1.42.69`, `1.42.68`, `1.42.67`
...
**Latest Version**: `2.31.33`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.33 -- $SHELL -i
```
