...
<details>
<summary>Show all 1127 versions</summary>
...
- `2.10.3`, `1.42.75`, `1.42.74`, `1.42.73`, `1.42.72`
...
**Latest Version**: `2.31.38`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.38 -- $SHELL -i
```
