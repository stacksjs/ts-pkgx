...
<details>
<summary>Show all 1100 versions</summary>
...
- `2.10.4`, `2.10.3`, `1.42.62`, `1.42.61`, `1.42.60`
...
**Latest Version**: `2.31.24`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.24 -- $SHELL -i
```
