...
<details>
<summary>Show all 1112 versions</summary>
...
- `2.11.8`, `2.11.7`, `2.10.4`, `2.10.3`, `1.42.67`
...
**Latest Version**: `2.31.31`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.31 -- $SHELL -i
```
