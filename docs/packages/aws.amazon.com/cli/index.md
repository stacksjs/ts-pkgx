...
<details>
<summary>Show all 1169 versions</summary>
...
- `2.10.4`, `2.10.3`, `1.44.3`, `1.44.2`, `1.44.1`
...
**Latest Version**: `2.32.20`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.32.20 -- $SHELL -i
```
