...
<details>
<summary>Show all 1179 versions</summary>
...
- `2.10.4`, `2.10.3`, `1.44.8`, `1.44.7`, `1.44.6`
...
**Latest Version**: `2.32.25`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.32.25 -- $SHELL -i
```
