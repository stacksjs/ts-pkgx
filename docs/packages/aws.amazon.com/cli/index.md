...
<details>
<summary>Show all 1119 versions</summary>
...
- `2.10.4`, `2.10.3`, `1.42.71`, `1.42.70`, `1.42.69`
...
**Latest Version**: `2.31.34`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.34 -- $SHELL -i
```
