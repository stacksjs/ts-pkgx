...
<details>
<summary>Show all 1130 versions</summary>
...
- `2.10.4`, `2.10.3`, `1.43.0`, `1.42.76`, `1.42.75`
...
**Latest Version**: `2.31.39`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.39 -- $SHELL -i
```
