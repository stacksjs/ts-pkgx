...
<details>
<summary>Show all 1171 versions</summary>
...
- `2.11.7`, `2.10.4`, `2.10.3`, `1.44.4`, `1.44.3`
...
**Latest Version**: `2.32.21`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.32.21 -- $SHELL -i
```
