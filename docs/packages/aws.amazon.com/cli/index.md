...
<details>
<summary>Show all 1161 versions</summary>
...
- `2.11.7`, `2.10.4`, `2.10.3`, `1.43.15`, `1.43.14`
...
**Latest Version**: `2.32.16`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.32.16 -- $SHELL -i
```
