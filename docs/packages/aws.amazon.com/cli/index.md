...
<details>
<summary>Show all 1097 versions</summary>
...
- `2.10.3`, `1.42.60`, `1.42.59`, `1.42.58`, `1.42.57`
...
**Latest Version**: `2.31.23`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.23 -- $SHELL -i
```
