...
<details>
<summary>Show all 1084 versions</summary>
...
- `1.42.54`, `1.42.53`, `1.42.51`, `1.42.50`, `1.42.49`
...
**Latest Version**: `2.31.17`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.17 -- $SHELL -i
```
