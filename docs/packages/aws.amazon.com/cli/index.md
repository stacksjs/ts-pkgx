...
<details>
<summary>Show all 1091 versions</summary>
...
- `2.11.7`, `2.10.4`, `2.10.3`, `1.42.57`, `1.42.56`
...
**Latest Version**: `2.31.20`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.20 -- $SHELL -i
```
