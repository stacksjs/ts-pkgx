...
<details>
<summary>Show all 1101 versions</summary>
...
- `2.11.7`, `2.10.4`, `2.10.3`, `1.42.62`, `1.42.61`
...
**Latest Version**: `2.31.25`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.25 -- $SHELL -i
```
