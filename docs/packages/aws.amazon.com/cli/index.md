...
<details>
<summary>Show all 1193 versions</summary>
...
- `2.11.8`, `2.11.7`, `2.10.4`, `2.10.3`, `1.44.15`
...
**Latest Version**: `2.32.32`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.32.32 -- $SHELL -i
```
