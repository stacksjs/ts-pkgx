...
<details>
<summary>Show all 1109 versions</summary>
...
- `2.10.4`, `2.10.3`, `1.42.66`, `1.42.65`, `1.42.64`
...
**Latest Version**: `2.31.29`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.31.29 -- $SHELL -i
```
