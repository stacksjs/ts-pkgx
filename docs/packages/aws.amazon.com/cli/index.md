...
<details>
<summary>Show all 1159 versions</summary>
...
- `2.10.4`, `2.10.3`, `1.43.14`, `1.43.13`, `1.43.12`
...
**Latest Version**: `2.32.15`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/cli@2.32.15 -- $SHELL -i
```
