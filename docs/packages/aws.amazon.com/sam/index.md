...
- `1.150.1`, `1.150.0`, `1.149.0`, `1.148.0`, `1.147.1`
- `1.146.0`, `1.145.2`, `1.145.1`, `1.145.0`, `1.144.0`
...
**Latest Version**: `1.150.1`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +aws.amazon.com/sam@1.150.1 -- $SHELL -i
```
