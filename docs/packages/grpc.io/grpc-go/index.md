...
- `1.77.0`, `1.76.0`, `1.75.1`, `1.75.0`, `1.74.3`
- `1.74.2`, `1.74.1`, `1.74.0`, `1.73.1`, `1.73.0`
- `1.72.3`, `1.72.2`, `1.72.1`, `1.72.0`, `1.71.3`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +grpc.io/grpc-go@1.77.0 -- $SHELL -i
```
