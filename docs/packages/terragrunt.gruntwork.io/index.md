...
<details>
<summary>Show all 420 versions</summary>

- `0.98.0`, `0.97.2`, `0.97.1`, `0.97.0`, `0.96.1`
- `0.96.0`, `0.95.1`, `0.95.0`, `0.94.0`, `0.93.13`
- `0.93.12`, `0.93.11`, `0.93.10`, `0.93.9`, `0.93.8`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +terragrunt.gruntwork.io@0.98.0 -- $SHELL -i
```
