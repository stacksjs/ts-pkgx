...
- `0.40.3`, `0.40.2`, `0.40.1`, `0.40.0`, `0.39.9`
- `0.39.7`, `0.39.6`, `0.39.5`, `0.39.4`, `0.39.3`
- `0.39.2`, `0.39.1`, `0.39.0`, `0.38.7`, `0.38.6`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +ast-grep.github.io@0.40.3 -- $SHELL -i
```
