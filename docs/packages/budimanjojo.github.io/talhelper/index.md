...
- `3.1.3`, `3.1.2`, `3.1.1`, `3.1.0`, `3.0.45`
- `3.0.44`, `3.0.43`, `3.0.42`, `3.0.41`, `3.0.40`
- `3.0.39`, `3.0.38`, `3.0.37`, `3.0.36`, `3.0.35`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +budimanjojo.github.io/talhelper@3.1.3 -- $SHELL -i
```
