...
- `3.16.41`, `3.16.40`, `3.16.39`, `3.16.35`, `3.16.34`
- `3.16.29`, `3.16.28`, `3.16.26`, `3.16.25`, `3.16.24`
...
**Latest Version**: `3.16.41`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +jenkins-x.io@3.16.41 -- $SHELL -i
```
