...
- `3.16.40`, `3.16.39`, `3.16.35`, `3.16.34`, `3.16.29`
- `3.16.28`, `3.16.26`, `3.16.25`, `3.16.24`, `3.16.21`
...
**Latest Version**: `3.16.40`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +jenkins-x.io@3.16.40 -- $SHELL -i
```
