...
- `2025.4.7.0`, `2025.4.28.0`, `2025.4.14.0`, `2025.3.31.0`, `2025.3.3.0`
- `2025.3.24.0`, `2025.3.10.0`, `2025.2.3.0`, `2025.2.24.0`, `2025.2.17.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +facebook.com/fbthrift@2026.1.5.0 -- $SHELL -i
```
