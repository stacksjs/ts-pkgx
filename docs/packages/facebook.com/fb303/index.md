...
- `2025.9.22.0`, `2025.9.15.0`, `2025.9.1.0`, `2025.8.4.0`, `2025.8.11.0`
...
- `2025.2.10.0`, `2025.12.29.0`, `2025.11.3.0`, `2025.11.24.0`, `2025.11.17.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +facebook.com/fb303@2026.1.5.0 -- $SHELL -i
```
