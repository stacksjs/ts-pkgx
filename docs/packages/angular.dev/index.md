...
- `21.1.1`, `21.1.0`, `21.0.6`, `21.0.5`, `21.0.4`
- `21.0.3`, `21.0.2`, `21.0.1`, `21.0.0`, `20.3.15`
- `20.3.14`, `20.3.12`, `20.3.11`, `20.3.10`, `20.3.9`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +angular.dev@21.1.1 -- $SHELL -i
```
