...
- `18.7.2`, `18.7.1`, `18.7.0`, `18.6.6`, `18.6.5`
- `18.6.4`, `18.6.3`, `18.6.2`, `18.6.1`, `18.6.0`
...
**Latest Version**: `18.7.2`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +gitlab.com/gitlab-org/gitlab-runner@18.7.2 -- $SHELL -i
```
