...
- `0.19.5`, `0.19.4`, `0.19.3`, `0.19.2`, `0.19.1`
- `0.19.0`, `0.18.19`, `0.18.18`, `0.18.17`, `0.18.16`
- `0.18.15`, `0.18.14`, `0.18.13`, `0.18.12`, `0.18.11`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +dagger.io@0.19.10 -- $SHELL -i
```
