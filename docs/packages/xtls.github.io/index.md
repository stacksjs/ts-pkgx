...
- `25.12.2`, `25.12.1`, `25.10.15`, `25.9.11`, `25.9.10`
- `25.9.5`, `25.8.31`, `25.8.3`, `25.7.26`, `25.7.25`
...
**Latest Version**: `25.12.2`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +xtls.github.io@25.12.2 -- $SHELL -i
```
