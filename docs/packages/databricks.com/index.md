...
- `0.284.0`, `0.283.0`, `0.282.0`, `0.281.0`, `0.280.0`
- `0.279.0`, `0.278.0`, `0.277.0`, `0.276.0`, `0.275.0`
...
**Latest Version**: `0.284.0`

### Install Specific Version

```bash
# Install specific version
sh <(curl https://pkgx.sh) +databricks.com@0.284.0 -- $SHELL -i
```
