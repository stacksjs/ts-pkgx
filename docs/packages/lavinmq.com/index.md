...
- `2.6.0`, `2.5.5`, `2.5.4`, `2.5.3`, `2.5.2`
- `2.5.1`, `2.5.0`, `2.4.5`, `2.4.4`, `2.4.3`
- `2.4.2`, `2.4.1`, `2.4.0`, `2.3.0`, `2.2.0`
- `2.1.0`, `2.0.2`, `2.0.1`, `2.0.0`, `1.3.1`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +lavinmq.com@2.6.0 -- $SHELL -i
```
