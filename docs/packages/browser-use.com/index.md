...
- `0.11.1`, `0.11.0`, `0.10.1`, `0.10.0`, `0.9.7`
- `0.9.6`, `0.9.5`, `0.9.4`, `0.9.3`, `0.9.2`
- `0.9.1`, `0.9.0`, `0.8.1`, `0.7.12`, `0.7.11`
...
- `0.5.1`, `0.5.0`, `0.4.5`, `0.4.4`, `0.4.3`
- `0.4.2`, `0.3.3`, `0.3.2`, `0.3.1`, `0.3.0`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +browser-use.com@0.11.1 -- $SHELL -i
```
