...
- `25.2.1`, `24.11.1`, `24.11.0`, `24.10.0`, `24.9.0`
...
- `23.0.0`, `22.21.1`, `22.21.0`, `22.20.0`, `22.19.0`
...
- `21.1.0`, `21.0.0`, `20.19.6`, `20.19.5`, `20.19.4`
...
```bash
# Install specific version
sh <(curl https://pkgx.sh) +nodejs.org@25.2.1 -- $SHELL -i
```
